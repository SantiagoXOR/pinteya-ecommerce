...
/api/admin/{resource}              // Colección
/api/admin/{resource}/{id}         // Recurso específico
/api/admin/{resource}/{id}/{action} // Acción específica
...
const getHandler = async (request: NextRequest) => {
  ...
  return NextResponse.json({
    ...
    links: {
      ...
      next: page * limit < (count || 0) ? `/api/admin/products?page=${page + 1}&limit=${limit}` : undefined,
