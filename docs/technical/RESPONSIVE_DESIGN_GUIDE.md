    ...
    <div className={container.full}>
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
        ...
        <main className="flex-1 min-w-0">
          ...
          ">
            <h1 className="text-heading-6 sm:text-heading-5 lg:text-heading-4">
              Productos
            </h1>
...
*Esta guía debe actualizarse regularmente conforme evolucionen las mejores prácticas y se identifiquen nuevas oportunidades de optimización.*