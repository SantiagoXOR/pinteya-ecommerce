...
export async function generateProductSEOText(product: ProductSEOData): Promise<string> {
  ...
  // Agregar beneficios
  seoText += 'Envío gratis en compras superiores a $50.000. Garantía de calidad. Atención personalizada.';
...
export async function generateCategorySEOText(category: CategorySEOData): Promise<string> {
  ...
  seoText += 'Productos de calidad, precios competitivos y envío gratis en compras superiores a $50.000. ';
  seoText += 'Compra online con la confianza de una empresa especializada en pinturería, ferretería y corralón.';
