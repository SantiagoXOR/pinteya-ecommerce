      ...
      await enterpriseAuditSystem.logEnterpriseEvent(
        {
          ...
          severity: errors.some(e => e.severity === 'critical')
            ? 'critical'
...
export const criticalValidator = new EnterpriseValidator(
  ENTERPRISE_VALIDATION_CONFIGS.CRITICAL_ADMIN
)
export const highValidator = new EnterpriseValidator(ENTERPRISE_VALIDATION_CONFIGS.HIGH_PAYMENT)
export const standardValidator = new EnterpriseValidator(
...
export const criticalSanitizer = new EnterpriseSanitizer(
  ENTERPRISE_VALIDATION_CONFIGS.CRITICAL_ADMIN
)
export const highSanitizer = new EnterpriseSanitizer(ENTERPRISE_VALIDATION_CONFIGS.HIGH_PAYMENT)
export const standardSanitizer = new EnterpriseSanitizer(
  ENTERPRISE_VALIDATION_CONFIGS.STANDARD_PUBLIC
)
