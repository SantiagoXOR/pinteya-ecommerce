 ...
 */
export const useCategoryData = (options: UseCategoryDataOptions = {}): UseCategoryDataReturn => {
  const {
    autoFetch = true,
  ...
  }, [getCachedData, enableBackgroundRefresh, fetchCategories, setCachedData, fallbackCategories])
