...
test.describe('Flujo Completo: Registro → Compra', () => {
  ...
  test('debe completar el flujo completo de registro y compra', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="mercadopago-info"]')).toContainText(
    ...
    await expect(page.locator('[data-testid="shipping-summary"]')).toContainText(
    ...
    await expect(page.locator('[data-testid="order-status"]').first()).toContainText(
      'Pendiente de Pago'
    )
  })
  ...
  test('debe validar stock durante el checkout', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="stock-error"]')).toContainText('Stock insuficiente')
  })
  ...
  test('debe manejar interrupciones de red durante el checkout', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="network-error"]')).toContainText('Error de conexión')
