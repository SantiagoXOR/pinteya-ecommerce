      ...
      <header role='banner' data-testid='header-component'>
        <div data-testid='header-wrapper' className='header-wrapper'>
          ...
          <div data-testid='user-actions'>
            <button data-testid='cart-component' onClick={() => setCartItems(prev => prev + 1)}>
              Carrito ({cartItems})
            </button>

            <button data-testid='login-component'>Iniciar Sesión</button>

            <button data-testid='hide-header' onClick={() => setIsVisible(false)}>
              Ocultar
            </button>
          </div>
        </div>
