...
describe('Sistema Enterprise de Auditoría de Seguridad', () => {
  ...
  beforeEach(() => {
    ...
    mockAnalyzeSecurityPatterns = analyzeSecurityPatterns as jest.MockedFunction<
      typeof analyzeSecurityPatterns
    >
    mockGetSecurityMetrics = getSecurityMetrics as jest.MockedFunction<typeof getSecurityMetrics>
    mockGetMetrics = metricsCollector.getMetrics as jest.MockedFunction<
      typeof metricsCollector.getMetrics
    >
  ...
  describe('Generación de Reportes Enterprise', () => {
    it('debe generar reporte enterprise completo', async () => {
      ...
      const mockGenerateSecurityReport = generateSecurityReport as jest.MockedFunction<
  ...
  describe('Manejo de Errores', () => {
    ...
    it('debe manejar errores en detección de anomalías', async () => {
      jest
        .spyOn(enterpriseAuditSystem as any, 'getRecentEvents')
    ...
    it('debe manejar errores en generación de reportes', async () => {
      ...
      await expect(
        enterpriseAuditSystem.generateEnterpriseReport(
          '2025-01-01T00:00:00.000Z',
          '2025-01-31T23:59:59.999Z'
        )
      ).rejects.toThrow()
