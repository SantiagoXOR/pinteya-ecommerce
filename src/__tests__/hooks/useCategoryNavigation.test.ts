...
describe('useCategoryNavigation Hook', () => {
  ...
  describe('Navigation Functions', () => {
    it('navigates to filtered view with categories', async () => {
      ...
      const { result } = renderHook(() => useCategoryNavigation({ enableAnalytics: true }))
  ...
  describe('URL Building', () => {
    it('builds correct URL with single category', () => {
      ...
      const { result } = renderHook(() => useCategoryNavigation())
  ...
  describe('Analytics Tracking', () => {
    ...
    it('does not track analytics when disabled', async () => {
      const { result } = renderHook(() => useCategoryNavigation({ enableAnalytics: false }))
  ...
  describe('Configuration Options', () => {
    it('uses custom parameter name', async () => {
      ...
      const { result } = renderHook(() => useCategoryNavigation({ paramName: 'filters' }))
    ...
    it('uses custom base path', async () => {
      ...
      const { result } = renderHook(() => useCategoryNavigation({ basePath: '/shop' }))
    ...
    it('respects custom debounce delay', async () => {
      ...
      const { result } = renderHook(() => useCategoryNavigation({ debounceDelay: 100 }))
  ...
  describe('Cleanup', () => {
    it('cleans up debounce timer on unmount', () => {
      ...
      const { unmount } = renderHook(() => useCategoryNavigation())
