  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        <label
          htmlFor="sizeM"
          className="cursor-pointer select-none flex items-center rounded-md bg-tahiti-gold-500 text-white hover:bg-tahiti-gold-500 hover:text-white"
        >
        ...
        <label
          htmlFor="sizeL"
          className="cursor-pointer select-none flex items-center rounded-md hover:bg-tahiti-gold-500 hover:text-white"
        >
          <div className="relative">
