...
export function RouteInfoDashboard({
  ...
  return (
    <div className={cn('bg-white rounded-lg shadow-lg p-4 border border-gray-200', className)}>
      ...
      <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-4'>
        ...
        <div className='text-center'>
          <div className='flex items-center justify-center mb-1'>
            ...
            <span className='text-lg font-bold text-gray-900'>{routeInfo.remainingDistance}</span>
          </div>
        ...
        <div className='text-center'>
          <div className='flex items-center justify-center mb-1'>
            ...
            <span className='text-lg font-bold text-gray-900'>{routeInfo.remainingDuration}</span>
          </div>
        ...
        <div className='text-center'>
          <div className='flex items-center justify-center mb-1'>
            ...
            <span className='text-lg font-bold text-gray-900'>
              {routeInfo.eta
                ? routeInfo.eta.toLocaleTimeString('es-ES', {
                    hour: '2-digit',
                    minute: '2-digit',
                  })
                : '--:--'}
      ...
      {routeInfo.trafficDelay > 5 && (
        <div className='mt-3 flex items-center justify-center bg-yellow-50 border border-yellow-200 rounded-lg p-3'>
          ...
          <div className='text-center'>
            <div className='text-sm font-medium text-yellow-800'>Demora por tráfico</div>
      ...
      <div className='mt-3 pt-3 border-t border-gray-200'>
        ...
        >
          ...
          <span>{showTrafficLayer ? 'Ocultar' : 'Mostrar'} Información de Tráfico</span>
        </button>
      </div>
