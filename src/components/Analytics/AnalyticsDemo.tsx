...
const AnalyticsDemo: React.FC = () => {
  ...
  const handleProductView = () => {
    trackProductView('demo-product-001', 'Pintura Demo Premium', 'Pinturas', 2500)
  }

  const handleAddToCart = () => {
    trackAddToCart('demo-product-001', 'Pintura Demo Premium', 2500, 1)
  }
  ...
  return (
    <div className='max-w-4xl mx-auto p-6 space-y-8'>
      ...
      <div className='text-center'>
        <h1 className='text-3xl font-bold text-gray-900 mb-4'>🎯 Demo del Sistema de Analytics</h1>
      ...
      >
        ...
        <h3 className='text-lg font-semibold text-gray-900 mb-2'>¡Sistema de Analytics Activo!</h3>
        <p className='text-gray-600 mb-4'>
          Todos los eventos de esta página se están registrando en tiempo real. Ve al dashboard de
          administración para ver las métricas completas.
        </p>
        <a
