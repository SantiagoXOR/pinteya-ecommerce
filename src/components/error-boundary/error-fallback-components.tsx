...
import { AlertTriangle, RefreshCw, Home, ShoppingCart, Search, User, Wifi, Package } from 'lucide-react';
...
export const CartErrorFallback: React.FC<ErrorFallbackProps> = ({
  onRetry,
  className = ''
}) => (
...
export const SearchErrorFallback: React.FC<ErrorFallbackProps> = ({
  onRetry,
  className = ''
}) => (
...
export const CompactErrorFallback: React.FC<ErrorFallbackProps> = ({
  ...
  <div className={`flex items-center gap-2 p-2 bg-red-50 border border-red-200 rounded ${className}`}>
          ...
          <div className="text-center pt-4 border-t">
            ...
            <Button 
              ...
              onClick={() => {
                ...
                window.open(`mailto:soporte@pinteya.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`);
              }}
            >
              Contactar soporte
            </Button>
