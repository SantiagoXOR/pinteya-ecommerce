...
import { Shield, Award, Truck, Clock, Users, Star } from 'lucide-react'
      ...
      <div className='max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
            Miles de clientes confían en nosotros para sus proyectos de pinturería. Descubre por qué
            somos la opción preferida en Argentina.
          </p>
        </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='grid grid-cols-4 gap-4 lg:gap-8'>
              ...
              <div className='text-center group cursor-pointer'>
                ...
                <h3 className='font-bold text-blaze-orange-600 text-xs lg:text-base transition-colors duration-300 group-hover:text-fun-green-600'>
                  Envíos
                </h3>
              </div>
              ...
              <div className='text-center group cursor-pointer'>
                ...
                <h3 className='font-bold text-blaze-orange-600 text-xs lg:text-base transition-colors duration-300 group-hover:text-blaze-orange-700'>
                  Asesoramiento
                </h3>
              </div>
              ...
              <div className='text-center group cursor-pointer'>
                ...
                <h3 className='font-bold text-blaze-orange-600 text-xs lg:text-base transition-colors duration-300 group-hover:text-yellow-600'>
                  Pagos
                </h3>
              </div>
              ...
              <div className='text-center group cursor-pointer'>
                ...
                <h3 className='font-bold text-blaze-orange-600 text-xs lg:text-base transition-colors duration-300 group-hover:text-blue-600'>
                  Cambios
                </h3>
              </div>
            </div>
