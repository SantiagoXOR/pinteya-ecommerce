    ...
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          ...
          <h3 className="font-medium text-dark ease-out duration-200 hover:text-tahiti-gold-500 mb-1.5">
            <Link href="/shop-details"> {item.title} </Link>
          </h3>

          <span className="flex items-center justify-center gap-2 font-medium text-lg">
            <span className="text-tahiti-gold-600 font-semibold">
        ...
        <div className="flex justify-center items-center">
          <SafeImage
            ...
            fallbackClassName="bg-tahiti-gold-50 border border-tahiti-gold-200"
          />
        </div>
        ...
        <div className="absolute right-0 bottom-0 translate-x-full u-w-full flex flex-col gap-2 p-5.5 ease-linear duration-300 group-hover:translate-x-0">
          <button
            ...
            id="bestOne"
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-white hover:bg-tahiti-gold-500"
          >
            <svg
