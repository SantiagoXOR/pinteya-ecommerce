...
import { Gift, Palette, Trophy, Sparkles, Clock, Star } from "lucide-react";
          ...
          <CardContent className="p-4 lg:p-6 xl:p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
              <div className="w-full relative z-10 order-1 lg:order-1">
                ...
                <p className="text-sm lg:text-base text-blaze-orange-700 mb-4 leading-relaxed">
                  Participá por un kit valorado en <span className="font-bold text-blaze-orange-600">$150.000</span> con productos premium de las mejores marcas: Plavicon, Petrilac, Sinteplast y más.
                </p>
                ...
                <div className="mb-5">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-semibold text-sm text-blaze-orange-800">Tiempo restante para participar:</span>
                  </div>
            ...
            <div className="mt-5 pt-4 border-t border-blaze-orange-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-semibold text-sm text-blaze-orange-800">Cómo participar:</span>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs text-blaze-orange-700">
                <div className="flex items-center gap-2">
                  <span className="bg-blaze-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">1</span>
                  <span>Seguinos en Instagram @pinteya</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-blaze-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">2</span>
                  <span>Compartí esta publicación en tu historia</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-blaze-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">3</span>
