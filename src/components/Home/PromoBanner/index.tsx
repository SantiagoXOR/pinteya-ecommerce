        ...
        <Card className="relative z-1 overflow-hidden bg-gradient-to-r from-blaze-orange-50 to-blaze-orange-100 py-12.5 lg:py-17.5 xl:py-22.5 px-4 sm:px-7.5 lg:px-14 xl:px-19 mb-7.5 border-0 shadow-2 hover:shadow-3 transition-all duration-300">
          <div className="max-w-[550px] w-full relative z-10">
            <div className="flex items-center gap-3 mb-4">
              <Badge variant="default" size="md" className="font-bold bg-blaze-orange-500 text-white">
                PLAVICON
              </Badge>
              <Badge variant="destructive" size="md" animation="pulse" className="font-bold bg-fun-green-500">
                40% OFF
              </Badge>
            </div>
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              Pintura látex de máxima calidad para frentes y exteriores.
              Resistente a la intemperie con tecnología argentina que protege y embellece.
            </p>
        ...
        <div className="grid gap-7.5 grid-cols-1 lg:grid-cols-2">
          ...
          <Card className="relative z-1 overflow-hidden bg-gradient-to-br from-yellow-50 to-yellow-100 py-10 xl:py-16 px-4 sm:px-7.5 xl:px-10 border-0 shadow-1 hover:shadow-2 transition-all duration-300 group">
            ...
            <div className="relative z-10">
              <Badge variant="warning" size="sm" className="mb-3 font-bold bg-yellow-500 text-black">
                30% OFF
              </Badge>

              <span className="block text-lg text-gray-700 mb-1.5">
                Sinteplast Antihumedad
              </span>
              ...
              <p className="max-w-[285px] text-sm text-gray-600 mb-6 leading-relaxed">
                Protección superior contra humedad y hongos.
                Ideal para baños, cocinas y ambientes húmedos.
              </p>
