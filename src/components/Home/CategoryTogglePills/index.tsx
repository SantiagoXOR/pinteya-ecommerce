          ...
          return (
            ...
            >
              ...
              `}>
                ...
                <span className={`hidden md:inline-block text-sm font-medium ml-1.5 ${isSelected ? '!text-white' : '!text-gray-900 dark:!text-white'}`}>
                  {category.name}
                </span>
              </Button>
              </div>
              <span className='text-[9px] font-medium text-center leading-[1.1] text-gray-700 dark:!text-white max-w-[85px] line-clamp-1 md:hidden truncate'>{category.name}</span>
            </div>
          )
        })}
      </div>
                    ...
                    className={`
                      ...
                      ${
                        isSelected && useDynamicCarousel
                          ...
                          : isSelected
                          ? 'bg-[#eb6313] hover:bg-[#bd4811] text-[#fff4c6] border-[#eb6313] shadow-md'
                          : 'bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 hover:shadow-lg text-gray-700 dark:!text-white border-gray-200 dark:border-gray-700 shadow-sm'
                      }
                    `}
                  >
                {category.image_url && (
