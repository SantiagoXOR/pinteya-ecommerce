...
export function NetworkErrorProvider({
  ...
  return (
    <NetworkErrorContext.Provider value={contextValue}>{children}</NetworkErrorContext.Provider>
  )
}
      ...
      <div className='min-h-screen flex items-center justify-center bg-gray-50'>
        <div className='max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center'>
          ...
          <p className='text-gray-600 mb-6'>
            Parece que hay un problema con tu conexión a internet. Por favor, verifica tu conexión e
            intenta nuevamente.
          </p>
