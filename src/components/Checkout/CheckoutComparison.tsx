...
const CheckoutComparison = () => {
  ...
  const comparisonData = {
    current: {
      ...
      pros: ['Información detallada', 'Control granular', 'Familiar para usuarios'],
      cons: [
        'Proceso largo',
    ...
    simplified: {
      ...
      pros: ['Proceso rápido', 'Menor abandono', 'Optimizado para móvil', 'UX moderna'],
      cons: ['Menos control granular', 'Cambio de paradigma'],
    },
  }
  ...
  return (
    <div className='max-w-6xl mx-auto p-6 space-y-8'>
      ...
      <div className='text-center'>
        <h1 className='text-3xl font-bold text-gray-900 mb-4'>Comparación de Checkout</h1>
        <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
          Compara el proceso de checkout actual con la nueva versión simplificada y descubre las
          mejoras en conversión y experiencia de usuario.
        </p>
      </div>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div className='text-center p-3 bg-gray-50 rounded-lg'>
                <div className='text-2xl font-bold text-gray-900'>
                  {comparisonData.current.steps}
                </div>
                <div className='text-sm text-gray-600'>Pasos</div>
              </div>
              <div className='text-center p-3 bg-gray-50 rounded-lg'>
                <div className='text-2xl font-bold text-gray-900'>
                  {comparisonData.current.timeToComplete}
                </div>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div className='text-center p-3 bg-primary/5 rounded-lg'>
                <div className='text-2xl font-bold text-primary'>
                  {comparisonData.simplified.steps}
                </div>
                <div className='text-sm text-gray-600'>Pasos</div>
              </div>
              <div className='text-center p-3 bg-primary/5 rounded-lg'>
                <div className='text-2xl font-bold text-primary'>
                  {comparisonData.simplified.timeToComplete}
                </div>
                <div className='text-sm text-gray-600'>Tiempo</div>
              </div>
            </div>
