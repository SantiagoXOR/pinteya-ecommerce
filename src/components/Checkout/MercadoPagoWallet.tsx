...
import { Loader2, CreditCard, AlertTriangle, CheckCircle, Shield, Lock } from '@/lib/optimized-imports'
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700'>
                  Acepta tarjetas de crédito, débito, efectivo y transferencias bancarias. Tus datos
                  están protegidos con encriptación de nivel bancario y certificación PCI DSS.
                </p>
