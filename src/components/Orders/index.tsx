...
const Orders = () => {
  ...
  const { orders, loading, error, pagination, statistics, fetchOrders, refreshOrders } =
        ...
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
          <div>
            ...
            <p className='text-sm text-gray-600'>
              Total: {statistics.total_orders} órdenes -{' '}
              {formatCurrency(statistics.total_spent.toString())} gastado
            </p>
          </div>
