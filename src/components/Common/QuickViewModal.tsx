...
const QuickViewModal = () => {
  ...
  // No renderizar el modal si no hay producto válido
  if (!product || !product.title || !product.imgs) {
    return null;
  }
                  ...
                  {product.imgs?.thumbnails?.map((img, key) => (
                    ...
                    >
                      {img ? (
                        ...
                        <div className="w-[61px] h-[61px] bg-gray-200 flex items-center justify-center rounded">
                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    ...
                    {product?.imgs?.previews?.[activePreview] ? (
                      ...
                      <div className="w-[400px] h-[400px] bg-gray-200 flex items-center justify-center rounded">
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className={`inline-flex font-medium text-white bg-tahiti-gold-500 py-3 px-7 rounded-md ease-out duration-200 hover:bg-tahiti-gold-700
                  `}
                >
                  Add to Cart
                </button>
