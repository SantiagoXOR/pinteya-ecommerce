...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[270px] mb-4">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          ...
          <button
            ...
            className="inline-flex font-medium text-custom-sm py-[7px] px-5 rounded-[5px] bg-tahiti-gold-500 text-white ease-out duration-200 hover:bg-tahiti-gold-700"
          >
            Add to cart
          </button>
          ...
          <button
            ...
            id="favOne"
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-tahiti-gold-500"
          >
            <svg
              className="fill-current"
              width="16"
      ...
      <h3
        className="font-medium text-dark ease-out duration-200 hover:text-tahiti-gold-500 mb-1.5"
