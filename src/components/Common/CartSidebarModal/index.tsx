      ...
      <Sheet open={isCartModalOpen} onOpenChange={closeCartModal}>
        ...
        >
          ...
          >
            ...
            {mounted && hasItems && (
              <div className={`px-6 sm:px-7.5 lg:px-11 bg-white pointer-events-none`} style={{ paddingTop: '0px', paddingBottom: '0px', marginBottom: '0px' }}>
          ...
          <div 
            ref={contentAreaRef}
            className={`flex-1 overflow-y-auto no-scrollbar px-6 sm:px-7.5 lg:px-11 ${hasItems ? 'pt-1' : isLargeText ? 'pt-1' : 'pt-2'} bg-gray-50 min-h-0`} 
          ...
          <div 
            className={`border-t border-gray-200 bg-white px-6 sm:px-7.5 lg:px-11 mt-auto flex-shrink-0 relative z-0`} 
            style={{ 
              paddingTop: '8px', 
