        ...
        <div className="p-6">
          ...
          <div className="space-y-3 pt-4 border-t border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <p className="font-semibold" style={{ color: '#ea5a17' }}>${totalPrice.toLocaleString()}</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                {shippingCost === 0 && (
                  <Badge className="bg-green-100 text-green-700 border-green-200" size="sm">Gratis</Badge>
                )}
              </div>
              <p className="font-semibold text-gray-900">
                {shippingCost === 0 ? (
            ...
            <div className="flex items-center justify-between pt-3 border-t border-gray-200">
              ...
              <p className="font-bold text-2xl" style={{ color: '#ea5a17' }}>${finalTotal.toLocaleString()}</p>
            </div>
          </div>
