            ...
            <Card className='border-0 shadow-2'>
              <div className='w-full overflow-x-auto'>
                <div className='min-w-[1170px]'>
                  ...
                  {/* <!-- cart item --> */}
                  {cartItems.length > 0 &&
                    cartItems.map((item: any, key: number) => <SingleItem item={item} key={key} />)}
                </div>
              </div>
            </Card>
            ...
            <Card className='text-center p-12 border-0 shadow-2'>
              <div className='mx-auto mb-8'>
                ...
                <p className='text-gray-600 mb-8'>
                  Descubre nuestros productos de pinturería profesional
                  <br />y comienza a crear algo increíble
                </p>
              </div>
