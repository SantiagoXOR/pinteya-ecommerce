...
export const CheckoutTransitionAnimation: React.FC<CheckoutTransitionAnimationProps> = ({
  ...
  }, [isActive, skipAnimation, router, onComplete, animationDuration, animationControls, handleProgress, onAnimationStart]);
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {!enablePerformanceMode && [...Array(8)].map((_, i) => (
          <motion.div
            key={i}
