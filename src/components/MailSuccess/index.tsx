    ...
    switch (mailType) {
      case 'contact':
        return {
          ...
          description:
            description ||
            'Recibimos tu consulta y te responderemos a la brevedad. Revisá tu bandeja de entrada para la confirmación.',
      ...
      case 'newsletter':
        return {
          ...
          description:
            description ||
            'Te suscribiste correctamente a nuestro newsletter. Recibirás las mejores ofertas y novedades.',
      ...
      case 'order':
        return {
          ...
          description:
            description ||
            'Tu pedido fue procesado correctamente. Te enviamos los detalles por email.',
          icon: <CheckCircle className='w-16 h-16 text-green-500' />,
          nextSteps: [
        ...
        <Card className='text-center'>
          ...
          <CardContent className='space-y-6'>
            ...
            {email && (
              <div className='bg-green-50 border border-green-200 rounded-lg p-4'>
                <div className='flex items-center justify-center space-x-2 text-green-700'>
                  ...
                  <span className='text-sm font-medium'>Enviado a: {email}</span>
                </div>
              </div>
            )}
            ...
            <div className='bg-gray-50 rounded-lg p-4 text-left'>
              <h4 className='font-semibold text-gray-900 mb-3'>¿Qué sigue ahora?</h4>
            ...
            <div className='border-t pt-4'>
              <p className='text-sm text-gray-500 mb-3'>Mientras tanto, podés:</p>
