      ...
      <div className="block md:hidden">
        <div className="max-w-7xl mx-auto px-4 py-4 pb-6">
          ...
          <div className="flex justify-center gap-2 mb-3">
            ...
            <Link href="/contact" className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full">
              Contacto
            </Link>
            <Link href="/about" className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full">
              Nosotros
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6 lg:gap-6">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg border border-purple-200">
                      ...
                      <span className="text-sm font-medium text-purple-800">Transferencia Bancaria</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-1 order-5">
              <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-3 md:mb-4">Seguinos</h3>
              <div className="space-y-2">
                <a
