      ...
      <div className='block md:hidden'>
        <div className='max-w-7xl mx-auto px-4 py-4 pb-6'>
          ...
          <div className='flex justify-center gap-2 mb-3'>
            <Link href='/shop' className='text-xs bg-gradient-to-r from-[#eb6313] to-[#bd4811] text-white px-3 py-1.5 rounded-full hover:scale-105 transition-transform shadow-md'>
              Tienda
            </Link>
            <Link
              href='/contact'
