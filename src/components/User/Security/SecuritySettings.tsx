...
import { useSecuritySettings, useSecurityAlerts, useSecurityValidation } from '@/hooks/useSecuritySettings';
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-center h-32">
          ...
          <span className="text-red-600">{error instanceof Error ? error.message : String(error) || 'Error desconocido'}</span>
        </div>
      </div>
    );
  }
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">
                {securityScore >= 80 ? 'Excelente' : 
                 securityScore >= 60 ? 'Buena' : 
                 securityScore >= 40 ? 'Regular' : 'Necesita mejoras'}
              </div>
            </div>
            <div className={`w-16 h-16 rounded-full flex items-center justify-center ${
              securityScore >= 80 ? 'bg-green-100 text-green-600' :
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateAlertSettings({ password_change_alerts: checked })}
                    disabled={isLoading}
                  />
                </div>
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSessionSettings({ trusted_devices_only: checked })}
                  disabled={isLoading}
                />
              </div>
