    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configura el idioma y la zona horaria de la aplicación.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600">
              Esta configuración solo afecta la visualización. Los precios reales pueden variar según el país.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Así se verá la información con tu configuración actual.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
