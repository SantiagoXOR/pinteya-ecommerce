...
export function PrivacySettings() {
  ...
  return (
    <div className='space-y-6'>
      <div>
        <h3 className='text-lg font-medium text-gray-900 mb-2'>Configuración de Privacidad</h3>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Controla quién puede ver tu información de perfil.</CardDescription>
        </CardHeader>
        ...
        <CardContent className='space-y-4'>
          <div className='space-y-4'>
            ...
            <div className='border-t pt-4'>
              ...
              <p className='text-sm text-gray-600 mb-3'>
                Eliminar permanentemente tu cuenta y todos los datos asociados. Esta acción no se
                puede deshacer.
              </p>
      ...
      <Card className='border-blue-200 bg-blue-50'>
        <CardContent className='pt-6'>
          <div className='flex items-start'>
            ...
            <div>
              <h4 className='font-medium text-blue-900 mb-1'>Compromiso con tu Privacidad</h4>
