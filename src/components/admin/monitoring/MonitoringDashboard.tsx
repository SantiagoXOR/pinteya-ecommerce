    ...
    <div className='space-y-6'>
      ...
      <Tabs defaultValue='overview' className='space-y-4'>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='grid grid-cols-2 gap-4 text-sm'>
                    ...
                    <div>
                      ...
                      <p className='text-muted-foreground'>{criticalAlerts.length}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
        ...
        <TabsContent value='alerts'>
          <div className='space-y-4'>
            <div className='flex justify-between items-center'>
              <h3 className='text-lg font-semibold'>Todas las Alertas ({alerts.length})</h3>
              <div className='flex space-x-2'>
                <Badge variant='outline'>Activas: {activeAlerts.length}</Badge>
                <Badge variant='outline'>Resueltas: {alerts.length - activeAlerts.length}</Badge>
              </div>
            </div>
