...
const BasicMonitoringExample: React.FC = () => {
  ...
  const { trackError, metrics, isEnabled, alerts } = useRenderMonitoring({
      ...
      <CardContent className='space-y-6'>
        ...
        {metrics && (
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
            ...
            <div className='space-y-1'>
              ...
              <p className='text-2xl font-bold text-orange-600'>{metrics.slowRenders}</p>
            </div>
            <div className='space-y-1'>
              <p className='text-sm font-medium flex items-center'>
        ...
        <div className='space-y-4'>
          ...
          <div className='flex flex-wrap gap-2'>
            <Button onClick={handleSlowOperation} disabled={isLoading} variant='outline' size='sm'>
              <Zap className='h-4 w-4 mr-1' />
              Render Lento
            </Button>
            ...
            <Button onClick={handleRenderLoop} variant='outline' size='sm'>
              <RefreshCw className='h-4 w-4 mr-1' />
              Render Loop
            </Button>
          </div>
          ...
          <div className='text-sm text-muted-foreground'>
            <p>
              <strong>Counter:</strong> {counter.toFixed(1)}
            </p>
            <p>
              <strong>Estado:</strong> {isLoading ? 'Procesando...' : 'Listo'}
            </p>
            <p>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Componente envuelto con withRenderMonitoring HOC</CardDescription>
      </CardHeader>
      <CardContent>
        <div className='space-y-4'>
...
export const MonitoringExample: React.FC = () => {
  return (
    <div className='space-y-6'>
      <div className='space-y-2'>
        <h2 className='text-2xl font-bold tracking-tight'>Ejemplos de Sistema de Monitoreo</h2>
        <p className='text-muted-foreground'>
          Componentes de ejemplo que demuestran las capacidades del sistema de monitoreo de
          renderizado
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className='space-y-2 text-sm'>
          <p>
            <strong>Render Lento:</strong> Simula una operación que bloquea el hilo principal
          </p>
          <p>
            <strong>Simular Error:</strong> Genera un error controlado para probar el tracking
          </p>
          <p>
            <strong>Render Loop:</strong> Causa múltiples re-renders rápidos
          </p>
          <p>
            <strong>Auto-increment:</strong> Genera renders constantes cada segundo
          </p>
