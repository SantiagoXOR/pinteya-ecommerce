            ...
            <div className='space-y-6'>
              ...
              <div>
                ...
                <div className='flex items-center justify-between mt-1'>
                  <div className='text-xs text-gray-500'>Recomendado: 30-60 caracteres</div>
                  <div
                    className={cn(
                      'text-xs',
                      seoTitle.length > 60
              ...
              <div>
                ...
                />
                <div className='flex items-center justify-between mt-1'>
                  <div className='text-xs text-gray-500'>Recomendado: 120-160 caracteres</div>
                  <div
                    className={cn(
                      'text-xs',
            ...
            <div className='border border-gray-200 rounded-lg p-4 bg-white'>
              <div className='space-y-2'>
                ...
                <div className='text-sm text-gray-600'>
                  {seoDescription ||
                    'Descripción del producto que aparecerá en los resultados de búsqueda...'}
                </div>
              </div>
            </div>
          </AdminCard>
