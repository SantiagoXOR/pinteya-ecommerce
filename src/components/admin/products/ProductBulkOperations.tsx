      ...
      <CardHeader>
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
          <div>
            ...
            <CardDescription>Gestión avanzada de productos con operaciones masivas</CardDescription>
          </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
          ...
          <div className='space-y-2'>
            ...
            <div className='flex flex-col gap-2'>
              <Dialog open={showImportDialog} onOpenChange={setShowImportDialog}>
                ...
                <ImportDialog onImport={onImportProducts} isLoading={isLoading} />
              </Dialog>
          ...
          <div className='space-y-2'>
            ...
            <div className='text-sm text-gray-600 space-y-1'>
              ...
              {hasSelection && (
                <>
                  <div>Activos: {selectedProducts.filter(p => p.is_active).length}</div>
                  <div>Inactivos: {selectedProducts.filter(p => !p.is_active).length}</div>
                </>
              )}
            </div>
          </div>
  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          Selecciona un archivo CSV con los productos a importar. El archivo debe tener las
          columnas: nombre, descripción, precio, stock, categoría.
        </DialogDescription>
      </DialogHeader>
  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          Aplicar cambios a {selectedProducts.length} producto
      ...
      <div className='space-y-4'>
        <div>
          ...
          <Select
            value={operation}
            onValueChange={(value: 'status' | 'category') => setOperation(value)}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
