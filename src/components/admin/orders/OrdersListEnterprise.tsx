      ...
      <CardHeader>
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
          <div>
            ...
            <CardDescription>Gestión completa de órdenes y estados</CardDescription>
          </div>
      ...
      <CardContent>
        {orders.length === 0 ? (
          ...
          <>
            ...
            {/* Paginación */}
            {pagination && <OrdersPagination pagination={pagination} />}
          </>
        )}
      </CardContent>
    </Card>
    ...
    <TableRow className='hover:bg-muted/50'>
      ...
      <TableCell>
        <div className='flex flex-col'>
          ...
          <span className='text-xs text-muted-foreground'>{order.user_profiles?.email}</span>
        </div>
      </TableCell>
  ...
  return (
    <div className='flex items-center justify-between pt-4'>
      <div className='text-sm text-muted-foreground'>
        ...
        {Math.min(pagination.currentPage * 25, pagination.totalItems)} de {pagination.totalItems}{' '}
        órdenes
      </div>
