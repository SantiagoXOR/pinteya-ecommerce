...
export const EditOrderModal: React.FC<EditOrderModalProps> = ({
  ...
  const getCurrentValue = (field: string, defaultValue: any = '') => {
    return (
      editedOrder[field as keyof typeof editedOrder] ??
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            updateNestedField('shipping_address', 'street', e.target.value)
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            updateNestedField('shipping_address', 'city', e.target.value)
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            updateNestedField('shipping_address', 'state', e.target.value)
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            updateNestedField('shipping_address', 'zip_code', e.target.value)
                          }
                        />
                      </div>
                    </div>
