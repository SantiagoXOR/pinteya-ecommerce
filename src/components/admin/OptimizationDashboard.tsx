  ...
  const executeCleanup = async () => {
    try {
      ...
      if (response.ok) {
        ...
        alert(`Limpieza completada: ${result.deleted} eventos eliminados, ${result.sizeFreed} liberados`);
      }
    } catch (error) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              {metrics?.total.reduction}%
            </div>
            <p className="text-xs text-gray-600">
              {metrics?.total.spaceSaved} ahorrados
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {metrics?.analytics.reduction}%
            </div>
            <p className="text-xs text-gray-600">
              {metrics?.analytics.spaceSaved} liberados
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">
              {metrics?.products.reduction}%
            </div>
            <p className="text-xs text-gray-600">
              {metrics?.products.spaceSaved} liberados
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600">
              {dbStats?.avgEventsPerDay || 0}/día promedio
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="products" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detalles de la optimización de la tabla de productos</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
