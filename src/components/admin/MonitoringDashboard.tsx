    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Sistema de monitoreo y alertas en tiempo real</p>
        </div>
            ...
            <CardHeader>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <CardDescription>Gestiona los patrones de detección de errores</CardDescription>
                </div>
                ...
                <div className='mb-6 p-4 border rounded-lg space-y-4'>
                  ...
                  <div className='grid gap-4 md:grid-cols-2'>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          setNewPattern({ ...newPattern, threshold: parseInt(e.target.value) })
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          setNewPattern({ ...newPattern, timeWindow: parseInt(e.target.value) })
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center space-x-2'>
                      <Switch
                        ...
                        onCheckedChange={checked =>
                          setNewPattern({ ...newPattern, isActive: checked })
                        }
                      />
                      <Label>Activo</Label>
                    </div>
                    <div className='space-x-2'>
                      ...
                      <Button onClick={handleAddPattern}>Agregar</Button>
                    </div>
                  </div>
                </div>
              )}
                  ...
                  >
                    <div className='flex-1'>
                      <div className='flex items-center space-x-2'>
                        ...
                        {!pattern.isActive && <Badge variant='secondary'>Inactivo</Badge>}
                      </div>
        ...
        <TabsContent value='config' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Ajusta los parámetros del sistema de monitoreo</CardDescription>
            </CardHeader>
              ...
              <div className='grid gap-4 md:grid-cols-2'>
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      handleConfigUpdate('responseTimeThreshold', parseInt(e.target.value))
                    }
                  />
                </div>
                <div className='space-y-2'>
