    ...
    <header className='bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-6'>
      ...
      <div className='flex items-center space-x-4'>
        ...
        {breadcrumbs && breadcrumbs.length > 0 && (
          <nav data-testid='breadcrumbs' className='hidden sm:flex items-center space-x-2 text-sm'>
        ...
        {/* Page Title */}
        {title && <h1 className='text-xl font-semibold text-gray-900 hidden sm:block'>{title}</h1>}
      </div>
                ...
                <div className='space-y-3'>
                  <div className='flex items-start space-x-3'>
                    ...
                    <div className='flex-1'>
                      <p className='text-sm text-gray-900'>Nueva orden recibida</p>
      ...
      {/* Mobile Actions */}
      {actions && <div className='sm:hidden fixed bottom-4 right-4 z-50'>{actions}</div>}
    </header>
  )
}
