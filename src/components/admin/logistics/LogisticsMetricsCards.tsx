...
export function LogisticsMetricsCards({ 
  ...
  const deliveryRate = stats.total_shipments > 0 
    ? (stats.delivered_shipments / stats.total_shipments) * 100 
    : 0;
    ...
    <div className={cn("grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", className)}>
      ...
      <MetricCard
        ...
        badge={{
          ...
          variant: deliveryRate >= 90 ? "default" : deliveryRate >= 80 ? "secondary" : "destructive"
        }}
      ...
      <MetricCard
        ...
        badge={{
          text: stats.average_delivery_time <= 3 ? "Rápido" : 
                stats.average_delivery_time <= 5 ? "Normal" : "Lento",
          variant: stats.average_delivery_time <= 3 ? "default" : 
                   stats.average_delivery_time <= 5 ? "secondary" : "destructive"
        }}
      ...
      <MetricCard
        ...
        badge={{
          text: stats.on_time_delivery_rate >= 95 ? "Excelente" : 
                stats.on_time_delivery_rate >= 85 ? "Bueno" : "Crítico",
          variant: stats.on_time_delivery_rate >= 95 ? "default" : 
                   stats.on_time_delivery_rate >= 85 ? "secondary" : "destructive"
        }}
      ...
      <MetricCard
        ...
        badge={{
          text: stats.active_couriers >= 3 ? "Diversificado" : 
                stats.active_couriers >= 2 ? "Básico" : "Limitado",
          variant: stats.active_couriers >= 3 ? "default" : 
                   stats.active_couriers >= 2 ? "secondary" : "destructive"
        }}
