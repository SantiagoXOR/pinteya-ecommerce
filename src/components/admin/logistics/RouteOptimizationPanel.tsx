                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <CardDescription>
                          {route.shipments?.length || 0} envíos • {route.total_distance} km •{' '}
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      <Badge variant='outline'>Score: {route.optimization_score}%</Badge>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  ...
                  {route.driver && (
                    <div className='flex items-center gap-2 pt-2 border-t'>
                      ...
                      <span className='text-sm'>
                        <strong>{route.driver.name}</strong> - {route.driver.vehicle_type} (
                        {route.driver.license_plate})
                      </span>
