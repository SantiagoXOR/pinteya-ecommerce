...
const QuickShipmentSchema = z.object({
  ...
  dimensions_cm: z.string().regex(/^\d+x\d+x\d+$/, 'Formato: LxWxH').optional(),
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-center space-x-4 py-4">
          ...
          <div className={cn(
            "h-0.5 w-12",
            step !== 'form' ? "bg-green-300" : "bg-gray-200"
          )} />
          <div className={cn(
            "flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium",
            step === 'quote' ? "bg-blue-100 text-blue-600" : 
          ...
          <div className={cn(
            "h-0.5 w-12",
            step === 'confirm' ? "bg-green-300" : "bg-gray-200"
          )} />
          <div className={cn(
            "flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium",
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {quotes.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground">No se encontraron cotizaciones disponibles</p>
                  </div>
                ) : (
                    ...
                    {quotes.map((quote, index) => (
                      <div
                        ...
                        className={cn(
                          ...
                          selectedQuote?.courier_id === quote.courier_id && "border-blue-500 bg-blue-50"
                        )}
            ...
            <div className="flex items-center justify-between pt-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button 
                  type="submit" 
                  disabled={isLoading || (step === 'quote' && !selectedQuote)}
                >
