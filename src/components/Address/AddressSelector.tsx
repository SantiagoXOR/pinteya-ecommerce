...
interface AddressSelectorProps {
  ...
  onAddressAdd: (
    address: Omit<AdvancedAddress, 'id' | 'user_id' | 'created_at' | 'updated_at'>
  ) => Promise<void>
  onAddressEdit: (
    id: string,
    address: Omit<AdvancedAddress, 'id' | 'user_id' | 'created_at' | 'updated_at'>
...
export function AddressSelector({
  ...
  const filteredAddresses = addresses.filter(
    address => filterType === 'both' || address.type === filterType || address.type === 'both'
  )
  ...
  const handleAddAddress = async (
    addressData: Omit<AdvancedAddress, 'id' | 'user_id' | 'created_at' | 'updated_at'>
  ) => {
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className='max-w-4xl max-h-[90vh] overflow-y-auto'>
                <DialogHeader>
                  ...
                  <DialogDescription>Completa los datos de tu nueva dirección.</DialogDescription>
                </DialogHeader>
                <AddressFormAdvanced
                  mode='create'
