/**
 * AuthSection simplificado para NextAuth
 * Versión funcional sin dependencias Clerk
 */
...
export default function AuthSection({ variant = 'default' }: AuthSectionProps) {
  ...
  if (variant === 'topbar') {
    ...
    return (
      <button
        onClick={() => signIn('google')}
        className='text-gray-800 hover:text-gray-900 text-xs px-2 py-1 h-auto bg-transparent hover:bg-gray-100 rounded transition-colors'
      >
        Iniciar Sesión
      </button>
    )
