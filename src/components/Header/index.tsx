                ...
                <div className='relative w-full'>
                  ...
                  >
                    <MemoizedSearchAutocomplete
                      ...
                      className='[&>div>div>input]:w-full [&>div>div>input]:border [&>div>div>input]:border-bright-sun-200 [&>div>div>input]:dark:border-gray-700 [&>div>div>input]:rounded-full [&>div>div>input]:pl-3 [&>div>div>input]:sm:pl-4 [&>div>div>input]:pr-10 [&>div>div>input]:py-1 [&>div>div>input]:text-blaze-orange-600 [&>div>div>input]:dark:text-gray-200 [&>div>div>input]:text-sm [&>div>div>input]:font-normal [&>div>div>input]:shadow-sm [&>div>div>input]:focus:border-bright-sun-300 [&>div>div>input]:dark:focus:border-blaze-orange-500 [&>div>div>input]:focus:ring-1 [&>div>div>input]:focus:ring-bright-sun-200 [&>div>div>input]:dark:focus:ring-blaze-orange-500 [&>div>div>input]:transition-all [&>div>div>input]:duration-200 [&>div>div>input]:hover:border-bright-sun-300 [&>div>div>input]:dark:hover:border-blaze-orange-600 [&>div>div>input]:!bg-white [&>div>div>input]:dark:!bg-gray-900'
                      debounceMs={100}
                      maxSuggestions={6}
              ...
              >
                <div className='relative w-full'>
                  ...
                  >
                    <MemoizedSearchAutocomplete
                      placeholder='Buscar productos...'
                      className='[&>div>div>input]:w-full [&>div>div>input]:border [&>div>div>input]:border-bright-sun-200 [&>div>div>input]:dark:border-gray-700 [&>div>div>input]:rounded-full [&>div>div>input]:pl-3 [&>div>div>input]:sm:pl-4 [&>div>div>input]:pr-3 [&>div>div>input]:sm:pr-4 [&>div>div>input]:py-1 [&>div>div>input]:text-blaze-orange-600 [&>div>div>input]:dark:text-gray-200 [&>div>div>input]:text-xs [&>div>div>input]:sm:text-sm [&>div>div>input]:font-normal [&>div>div>input]:shadow-sm [&>div>div>input]:focus:border-bright-sun-300 [&>div>div>input]:dark:focus:border-blaze-orange-500 [&>div>div>input]:focus:ring-1 [&>div>div>input]:focus:ring-bright-sun-200 [&>div>div>input]:dark:focus:ring-blaze-orange-500 [&>div>div>input]:transition-all [&>div>div>input]:duration-200 [&>div>div>input]:hover:border-bright-sun-300 [&>div>div>input]:dark:hover:border-blaze-orange-600 [&>div>div>input]:!bg-white [&>div>div>input]:dark:!bg-gray-900'
                      debounceMs={100}
                      maxSuggestions={6}
                      showRecentSearches={true}
                      showTrendingSearches={true}
