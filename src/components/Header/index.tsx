        ...
        >
          ...
          <div className="flex w-full lg:w-auto items-center gap-3 lg:gap-5">
            <div className="hidden lg:flex items-center gap-2.5">
              ...
              <div>
                <span className="block text-2xs text-white/80 uppercase">
                  24/7 SUPPORT
                </span>
                  ...
                  <span className="inline-block relative">
                    <svg
                      ...
                      className={`transition-colors duration-200 text-white ${
                        isAnimating ? 'text-fun-green-400' : ''
                      }`}
                    >
                      <path
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path || '#'}
                          className={`hover:text-white text-custom-sm font-medium text-white flex ${
