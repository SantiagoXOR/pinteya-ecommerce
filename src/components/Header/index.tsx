...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Accesorios de Pintura", value: "2" },
    { label: "Herramientas", value: "3" },
    { label: "Materiales de Construcción", value: "4" },
  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-3 lg:gap-5 items-start lg:items-center xl:justify-between ease-out duration-200 ${
        ...
        >
          ...
          {/* <!-- header top right --> */}
          <div className="flex w-full lg:w-auto items-center gap-3 lg:gap-5">
            ...
            {/* <!-- divider --> */}
            <span className="hidden lg:block w-px h-6 bg-gray-4"></span>
                ...
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className="group relative before:w-0 before:h-[3px] before:bg-tahiti-gold-500 before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full "
                      >
                        <Link
                          href={menuItem.path || '#'}
                          className={`hover:text-tahiti-gold-500 text-custom-sm font-medium text-dark flex ${
