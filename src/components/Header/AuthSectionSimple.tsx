/**
 * Componente de Autenticación Simplificado - NextAuth.js
 * Versión temporal sin dependencias de Clerk
 */
...
const AuthSectionSimple = ({ variant = 'desktop' }: AuthSectionProps) => {
  // Versión mobile
  if (variant === 'mobile') {
    return (
