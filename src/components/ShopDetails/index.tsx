                      ...
                      installments={{
                        ...
                        amount: Math.round(
                          ((product.discountedPrice || product.price) * 100) /
                            ((product.discountedPrice || product.price) >= 10000 ? 6 : 3)
                        ),
                        interestFree: true,
                      }}
                  ...
                  <div className='mb-6'>
                    ...
                    <div className='max-w-sm'>
                      <CommercialProductCard
                        ...
                        installments={
                          (product.discountedPrice || product.price) >= 5000
                            ? {
                                quantity: 3,
                            ...
                            >
                              <div className='relative'>
                                ...
                                >
                                  <span
                                    className={
                                      state.storage === item.id ? 'opacity-100' : 'opacity-0'
                                    }
                                  >
                                    <svg
                                      width='24'
                          ...
                          {types.map((item, key) => (
                            ...
                            >
                              <div className='relative'>
                                ...
                                <div
                                  className={`mr-2 flex h-4 w-4 items-center justify-center rounded border ${
                                    state.type === item.id ? 'border-blue bg-blue' : 'border-gray-4'
                                  } `}
                                >
                                  <span
                                    className={state.type === item.id ? 'opacity-100' : 'opacity-0'}
                                  >
                                    <svg
                                      width='24'
                                      height='24'
                          ...
                          {sims.map((item, key) => (
                            ...
                            >
                              <div className='relative'>
                                ...
                                <div
                                  className={`mr-2 flex h-4 w-4 items-center justify-center rounded border ${
                                    state.sim === item.id ? 'border-blue bg-blue' : 'border-gray-4'
                                  } `}
                                >
                                  <span
                                    className={state.sim === item.id ? 'opacity-100' : 'opacity-0'}
                                  >
                                    <svg
                                      width='24'
                                      height='24'
                    ...
                    <div className='flex flex-wrap items-center gap-4'>
                      ...
                      <div className='flex items-center rounded-lg border border-gray-300 bg-white shadow-sm'>
                        <Button
                          ...
                          size='icon'
                          onClick={() =>
                            state.quantity > 1 && actions.setQuantity(state.quantity - 1)
                          }
