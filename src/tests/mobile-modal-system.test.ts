...
import { MobileModalOverlay, NavigationModalOverlay, InfoModalOverlay } from '@/components/driver/MobileModalOverlay';
...
function TestModalComponent() {
  ...
  return (
    <div>
      ...
      <button 
        onClick={() => modalActions.openRouteInfo()}
        data-testid="open-route-info"
      >
        Abrir Info Ruta
      </button>
      
      <button 
        onClick={() => modalActions.openAdvancedControls()}
