...
export const navigationStructure = {
  ...
  mobileMenu: {
    ...
    width: '280px',
    backdrop: true,
    sections: ['user-profile', 'main-navigation', 'secondary-links', 'social-links'],
  },
...
export const pageLayouts = {
  ...
  shopWithSidebar: {
    ...
    sidebar: {
      ...
      sticky: true,
      topOffset: '80px',
      sections: ['search', 'categories', 'price-range', 'brands', 'ratings', 'attributes'],
    },
    content: {
      toolbar: {
        height: '60px',
  ...
  checkout: {
    ...
    steps: ['shipping-info', 'payment-method', 'review-order'],
    progress: {
      type: 'stepper',
      showLabels: true,
    },
