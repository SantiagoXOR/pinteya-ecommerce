...
export const iconography = {
  ...
  categories: {
    ...
    user: ['user', 'user-circle', 'login', 'logout', 'settings', 'bell', 'mail', 'phone'],
    product: ['eye', 'zoom-in', 'image', 'play', 'share', 'bookmark', 'tag', 'percent'],
    status: ['check', 'x', 'alert-triangle', 'info', 'loading', 'clock', 'calendar', 'map-pin'],
  },
