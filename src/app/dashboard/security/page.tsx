    ...
    <div className='space-y-6'>
          ...
          {twoFactorEnabled && (
            <div className='mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg'>
              <p className='text-sm text-blue-800'>
                La autenticación de dos factores está habilitada. Necesitarás tu dispositivo móvil
                para iniciar sesión.
              </p>
            </div>
          )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configura cómo quieres recibir alertas de seguridad.</CardDescription>
        </CardHeader>
        <CardContent>
