...
} from '@/lib/integrations/mercadopago/mercadopago-mock'
    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4'>
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-gray-600'>Simulador de MercadoPago para testing local</p>
        </div>
            ...
            <CardContent className='p-6 space-y-4'>
              ...
              <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
                <div className='flex items-center gap-2 mb-2'>
                  ...
                  <span className='text-sm font-medium text-yellow-800'>Modo de Prueba</span>
                </div>
                <p className='text-sm text-yellow-700 mb-3'>
                  Usa datos de prueba para simular diferentes resultados
                </p>
                <Button onClick={handleUseTestCard} variant='outline' size='sm' className='w-full'>
            ...
            <CardContent className='p-6'>
              ...
              <div className='mt-6 bg-gray-50 rounded-lg p-4'>
                ...
                <div className='text-sm space-y-1 text-gray-600'>
                  <p>
                    <strong>Aprobada:</strong> 4509 9535 6623 3704
                  </p>
                  <p>
                    <strong>Rechazada:</strong> 4013 5406 8274 6260
                  </p>
                  <p>
                    <strong>Titular:</strong> APRO APRO / OTHE OTHE
                  </p>
                  <p>
              ...
              <div className='mt-4 bg-blue-50 rounded-lg p-4'>
                ...
                <div className='text-sm space-y-1 text-gray-600'>
                  ...
                  <p>
                    <strong>Entorno:</strong> {isSandbox ? 'Sandbox' : 'Testing'}
                  </p>
                  <p>
                    <strong>Modo:</strong> Simulación Local
                  </p>
                </div>
              </div>
            </CardContent>
