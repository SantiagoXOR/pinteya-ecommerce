    ...
    <main className='min-h-screen bg-gray-50 py-8'>
      <div className='max-w-4xl mx-auto px-4'>
        <div className='bg-white rounded-lg shadow-md p-6'>
          <h1 className='text-2xl font-bold text-gray-900 mb-6'>✅ Checkout Funcionando</h1>

          <div className='space-y-4'>
            <div className='p-4 bg-green-50 border border-green-200 rounded-md'>
              <h2 className='text-lg font-semibold text-green-800 mb-2'>🎉 ¡Problema Resuelto!</h2>
            ...
            <div className='p-4 bg-yellow-50 border border-yellow-200 rounded-md'>
              <h3 className='text-md font-semibold text-yellow-800 mb-2'>🔧 Próximos Pasos:</h3>
