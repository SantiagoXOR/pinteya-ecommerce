...
export const metadata: Metadata = {
  ...
  description:
    'Calcula la cantidad exacta de pintura que necesitas para tu proyecto. Cotizador gratuito y fácil de usar.',
              ...
              <CardContent className='space-y-6'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div>
                    ...
                    <Input type='number' placeholder='ej: 4.5' className='w-full' />
                  </div>
                  <div>
                    <label className='block text-sm font-medium text-gray-700 mb-2'>
                      Alto (metros)
                    </label>
                    <Input type='number' placeholder='ej: 2.8' className='w-full' />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    className='w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary/20 focus:border-primary'
                    defaultValue='2'
                  >
              ...
              <Card>
                ...
                <CardContent>
                  <div className='text-center py-8'>
                    <div className='text-4xl font-bold text-primary mb-2'>12.5L</div>
                    <p className='text-gray-600 mb-4'>Cantidad total de pintura necesaria</p>
