...
const faqData: FAQItem[] = [
  {
    ...
    answer: 'Puedes realizar un pedido navegando por nuestro catálogo, agregando productos al carrito y siguiendo el proceso de checkout. También puedes contactarnos directamente para pedidos especiales.',
    category: 'pedidos'
  },
  {
    id: '2',
    question: '¿Qué métodos de pago aceptan?',
    answer: 'Aceptamos tarjetas de crédito, débito, transferencias bancarias y MercadoPago. También ofrecemos opciones de financiamiento para compras mayores.',
    category: 'pagos'
  },
  {
    id: '3',
    question: '¿Hacen envíos a todo el país?',
    answer: 'Sí, realizamos envíos a toda Argentina. Los tiempos de entrega varían según la ubicación. Consulta los costos y tiempos en el checkout.',
    category: 'envios'
  },
  {
    id: '4',
    question: '¿Puedo devolver un producto?',
    answer: 'Sí, aceptamos devoluciones dentro de los 30 días posteriores a la compra, siempre que el producto esté en condiciones originales.',
    category: 'devoluciones'
  },
  {
    id: '5',
    question: '¿Ofrecen asesoramiento técnico?',
    answer: 'Sí, nuestro equipo de especialistas puede asesorarte sobre la elección de productos, técnicas de aplicación y cálculo de materiales.',
    category: 'asesoramiento'
  },
  {
    id: '6',
    question: '¿Tienen garantía los productos?',
    answer: 'Todos nuestros productos cuentan con la garantía del fabricante. La duración varía según el producto y la marca.',
    category: 'garantias'
  }
];
