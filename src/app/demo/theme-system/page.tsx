      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        <div className='text-center mb-12'>
          <div className='flex items-center justify-center gap-4 mb-4'>
            <h1 className='text-4xl font-bold'>🎨 Sistema de Temas - Pinteya Design System</h1>
            <ThemeModeToggle />
          </div>
        ...
        <section className='mb-12'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3'>
                <PriceDisplay amount={8500} originalAmount={10000} showDiscountPercentage />
                <PriceDisplay
                  amount={15000}
                  installments={{
                    quantity: 6,
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3'>
                ...
                <StockIndicator quantity={3} lowStockThreshold={5} showExactQuantity unit='latas' />
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3'>
                ...
                <ShippingInfo variant='inline' showCalculator />
              </div>
            </div>
          </div>
        </section>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm font-mono'>
              ...
              <div>
                ...
                <div className='space-y-1 text-text-tertiary'>
                  ...
                  <div>
                    --color-ecommerce-stock-available: {theme.colors.ecommerce.stock.available}
                  </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              <div>
                ...
                <div className='space-y-1 text-sm text-text-secondary'>
                  ...
                  <div>
                    Tema: <span className='font-mono'>{theme.name}</span>
                  </div>
                </div>
              </div>
        ...
        <div className='text-center py-8 border-t border-border-primary'>
          <p className='text-text-secondary'>🎨 Sistema de Temas Pinteya - Fase 2 completada</p>
