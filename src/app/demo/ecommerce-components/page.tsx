      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Nuevos componentes especializados para e-commerce inspirados en MercadoPago y
            optimizados para el mercado argentino de pinturería.
          </p>
        </div>
            ...
            <div className='bg-white rounded-lg p-6 shadow-sm'>
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <StockIndicator quantity={0} allowPreOrder />
                </div>
              </div>
            </div>
            ...
            <div className='bg-white rounded-lg p-6 shadow-sm'>
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <ShippingInfo variant='inline' showCalculator postalCode='1425' />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className='mb-16'>
          <h2 className='text-3xl font-semibold text-gray-900 mb-8'>
            🏪 Productos de Pinturería con Nuevos Componentes
          </h2>
