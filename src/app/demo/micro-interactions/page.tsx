      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            🎨 Micro-interacciones Pinteya
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Demostración de las nuevas micro-interacciones y animaciones implementadas 
            para mejorar la experiencia de usuario en Pinteya E-commerce.
          </p>
        </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="space-y-4">
              ...
              <AnimatedButton size="sm" variant="primary">Pequeño</AnimatedButton>
              <AnimatedButton size="md" variant="primary">Mediano</AnimatedButton>
              <AnimatedButton size="lg" variant="primary">Grande</AnimatedButton>
            </div>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">ProductCard con Micro-interacciones</h2>
