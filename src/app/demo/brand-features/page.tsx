      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-8'>
          ...
          <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
            Demostración de las nuevas funcionalidades de marcas implementadas en Pinteya
            E-commerce. Incluye filtros, visualización y APIs actualizadas.
          </p>
        </div>
          ...
          <div className='lg:col-span-3 space-y-6'>
            ...
            <div>
              <div className='flex items-center justify-between mb-6'>
                ...
                {isLoadingProducts && <Badge variant='outline'>Cargando...</Badge>}
              </div>
              ...
              <CardContent className='space-y-4'>
                <div>
                  ...
                  <ul className='text-sm space-y-1 text-gray-600'>
                    <li>
                      • <code>GET /api/brands</code> - Lista de marcas con conteo
                    </li>
                    <li>
                      • <code>GET /api/products?brand=X</code> - Filtro por marca
                    </li>
                    <li>
                      • <code>GET /api/products?search=X</code> - Búsqueda incluye marcas
                    </li>
                    <li>
                      • <code>GET /api/products?sortBy=brand</code> - Ordenamiento por marca
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className='text-sm space-y-1 text-gray-600'>
                    <li>
                      • <code>BrandFilter</code> - Filtro completo con búsqueda
                    </li>
                    <li>
                      • <code>BrandFilterCompact</code> - Filtro compacto con badges
                    </li>
                    <li>
                      • <code>useBrandFilter</code> - Hook para manejo de estado
                    </li>
                    <li>
                      • <code>CommercialProductCard</code> - Actualizado con visualización de marca
                    </li>
                  </ul>
                </div>
              </CardContent>
