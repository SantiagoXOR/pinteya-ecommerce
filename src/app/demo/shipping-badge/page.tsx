        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='mb-8 text-center'>
            <p className='text-gray-600 mb-4'>
              Comparación del badge de envío gratis antes y después de la implementación del ícono
              SVG personalizado.
            </p>
          </div>
          ...
          <div className='bg-white rounded-lg p-6 shadow-sm'>
            <h2 className='text-xl font-semibold mb-4 text-[#712F00]'>
          ...
          <div className='mt-8 bg-green-50 border border-green-200 rounded-lg p-4'>
            ...
            <p className='text-green-700 text-sm'>
              ...
              <code className='bg-green-100 px-1 rounded'>public/images/icons/icon-envio.svg</code>y
              mantiene la paleta de colores verde del sistema de diseño Pinteya.
            </p>
          </div>
        </div>
      </div>
