...
const demoPages = [
  {
    ...
    description:
      'Sistema completo de filtrado y gestión de marcas de productos. Incluye filtros avanzados, búsqueda por marca y componentes especializados.',
  ...
  },
  {
    ...
    description:
      'Colección completa de componentes especializados para e-commerce: PriceDisplay, StockIndicator, ShippingInfo y más.',
  ...
  },
  {
    ...
    description:
      'Versión avanzada del ProductCard con integración completa del Design System y funcionalidades inteligentes.',
  ...
  },
  {
    ...
    description:
      'Componente ProductCard básico con funcionalidades esenciales para mostrar productos en la tienda.',
  ...
  },
  {
    ...
    description:
      'Demostración del Design System completo con tokens, componentes y temas personalizables.',
    ...
    <div className='min-h-screen bg-gray-50 py-8'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-12'>
          <h1 className='text-4xl font-bold text-gray-900 mb-4'>Demos y Ejemplos</h1>
        ...
        <div className='mt-16 text-center'>
          <div className='bg-white rounded-lg p-8 shadow-sm border'>
            ...
            <p className='text-gray-600 mb-6'>
              Todos estos demos están completamente documentados y listos para producción. Explora
              el código fuente y la documentación técnica para implementar estas funcionalidades.
            </p>
            <div className='flex justify-center gap-4'>
              <Button asChild>
                <Link href='/menu'>Ver Menú Principal</Link>
              </Button>
