    ...
    <div className='p-4 space-y-6 max-w-md mx-auto'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Gestiona tus rutas asignadas y navegación</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className='grid grid-cols-3 gap-3'>
        <Card>
          <CardContent className='p-4 text-center'>
            <div className='text-2xl font-bold text-blue-600'>{plannedRoutes.length}</div>
            <div className='text-xs text-gray-600'>Planificadas</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='p-4 text-center'>
            <div className='text-2xl font-bold text-green-600'>{activeRoute ? 1 : 0}</div>
            <div className='text-xs text-gray-600'>Activa</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='p-4 text-center'>
            <div className='text-2xl font-bold text-gray-600'>{completedRoutes.length}</div>
        ...
        <Card className='border-green-200 bg-green-50'>
          <CardHeader className='pb-3'>
            <div className='flex items-center justify-between'>
              <CardTitle className='text-lg text-green-900'>Ruta Activa</CardTitle>
            ...
            <div>
              ...
              <div className='grid grid-cols-2 gap-4 mt-3 text-sm'>
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <span>
                    {Math.round(activeRoute.estimated_time / 60)}h {activeRoute.estimated_time % 60}
                    m
                  </span>
                </div>
                <div className='flex items-center space-x-2'>
              ...
              <CardContent className='p-4'>
                ...
                <div className='grid grid-cols-2 gap-4 text-sm text-gray-600'>
                  ...
                  <div className='flex items-center space-x-2'>
                    ...
                    <span>
                      {Math.round(route.estimated_time / 60)}h {route.estimated_time % 60}m
                    </span>
                  </div>
                  <div className='flex items-center space-x-2'>
      ...
      {filteredRoutes.length === 0 && (
        <Card>
          <CardContent className='text-center py-8'>
            ...
            <h3 className='font-medium text-gray-900 mb-2'>No hay rutas para esta fecha</h3>
