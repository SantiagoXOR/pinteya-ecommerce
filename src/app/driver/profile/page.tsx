    ...
    <div className='p-4 space-y-6 max-w-md mx-auto'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Resumen de tu desempeño como driver</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className='bg-gray-50'>
        <CardContent className='p-4 text-center'>
          <p className='text-xs text-gray-500'>Pinteya Driver App v1.0.0</p>
          <p className='text-xs text-gray-500'>© 2024 Pinteya E-commerce</p>
        </CardContent>
      </Card>
    </div>
  )
