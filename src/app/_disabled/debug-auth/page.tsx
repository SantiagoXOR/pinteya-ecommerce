        ...
        <div className='bg-white rounded-lg shadow-lg p-6'>
          ...
          <div className='mb-6'>
            <h2 className='text-lg font-semibold mb-3'>
              Información del Cliente (useUser/useAuth)
            </h2>
            <div className='bg-gray-50 rounded-lg p-4'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
                  <p>
                    <strong>Usuario ID:</strong> {userId || 'No autenticado'}
                  </p>
                  <p>
                    <strong>Sesión ID:</strong> {sessionId || 'Sin sesión'}
                  </p>
                  <p>
                ...
                <div>
                  ...
                  <p>
                    <strong>Organizaciones:</strong> {user?.organizationMemberships?.length || 0}
                  </p>
                </div>
              </div>
            </div>
          ...
          {debugInfo && (
            <div className='space-y-6'>
              <div>
                ...
                <div className='bg-gray-50 rounded-lg p-4'>
                  ...
                  <p>
                    ...
                    {debugInfo.authentication.isAuthenticated ? '✅ Sí' : '❌ No'}
                  </p>
                  <p>
                    <strong>User ID:</strong> {debugInfo.authentication.userId || 'N/A'}
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div
                  className={`rounded-lg p-4 ${debugInfo.roleCheck.hasAdminRole ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}
                >
                  <p
                    className={`font-semibold ${debugInfo.roleCheck.hasAdminRole ? 'text-green-800' : 'text-red-800'}`}
                  >
                  ...
                  <div className='mt-2 space-y-1 text-sm'>
                    <p>
                      <strong>Rol en Session Claims:</strong>{' '}
                      {debugInfo.roleCheck.roleFromSessionClaims || 'N/A'}
                    </p>
                    <p>
                      <strong>Rol en Public Metadata:</strong>{' '}
                      {debugInfo.roleCheck.roleFromPublicMetadata || 'N/A'}
                    </p>
                    <p>
                      <strong>Rol en Private Metadata:</strong>{' '}
                      {debugInfo.roleCheck.roleFromPrivateMetadata || 'N/A'}
                    </p>
                  </div>
                </div>
              </div>
