          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
            ...
            >
              ...
              <div className='space-y-2 text-sm'>
                <p>
                  <strong>Loaded:</strong> {isLoaded ? 'Sí' : 'No'}
                </p>
                <p>
                  <strong>Signed In:</strong> {isSignedIn ? 'Sí' : 'No'}
                </p>
                <p>
            ...
            >
              <h2 className='text-xl font-semibold mb-4'>🎫 Token de Autenticación</h2>
              <div className='space-y-2 text-sm'>
                <p>
                  <strong>Tiene Token:</strong> {tokenInfo?.hasToken ? 'Sí' : 'No'}
                </p>
                <p>
                  <strong>Longitud:</strong> {tokenInfo?.tokenLength || 0} caracteres
                </p>
                <p>
                  <strong>Preview:</strong> {tokenInfo?.tokenPreview || 'N/A'}
                </p>
                {error && (
            ...
            <div className='bg-blue-50 border-2 border-blue-200 rounded-lg p-6 mb-8'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                <div>
                  ...
                  <p>
                    <strong>Nombre:</strong> {user.firstName || 'N/A'} {user.lastName || 'N/A'}
                  </p>
                  <p>
                ...
                <div>
                  ...
                  <p>
                    ...
                    {user.primaryEmailAddress?.verification?.status || 'N/A'}
                  </p>
                </div>
              </div>
            </div>
