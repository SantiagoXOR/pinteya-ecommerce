              ...
              <div className='bg-gray-50 rounded-lg p-4 mb-4'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  ...
                  <div>
                    ...
                    {debugInfo.roleCheck.roleFromSessionClaims || 'No encontrado'}
                  </div>
                  <div>
                    <strong>Rol en Public Metadata:</strong>{' '}
                    {debugInfo.roleCheck.roleFromPublicMetadata || 'No encontrado'}
                  </div>
                  <div>
                    <strong>Rol en Private Metadata:</strong>{' '}
                    {debugInfo.roleCheck.roleFromPrivateMetadata || 'No encontrado'}
                  </div>
                </div>
              </div>
