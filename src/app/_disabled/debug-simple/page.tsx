      ...
      <div className="space-y-6">
        <div className="bg-gray-100 p-4 rounded">
          ...
          <ul className="space-y-1 text-sm">
            <li>NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: {process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY ? 'Configurada' : 'No configurada'}</li>
            <li>NEXT_PUBLIC_SUPABASE_URL: {process.env.NEXT_PUBLIC_SUPABASE_URL ? 'Configurada' : 'No configurada'}</li>
