...
import { User, Mail, Calendar, ArrowLeft, Edit } from '@/lib/optimized-imports'
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-blue-700 mt-1'>
                    Para editar tu información personal, puedes hacerlo a través de tu proveedor de
                    autenticación (Google). Los cambios se reflejarán automáticamente en tu perfil.
                  </p>
                </div>
              </div>
            </CardContent>
