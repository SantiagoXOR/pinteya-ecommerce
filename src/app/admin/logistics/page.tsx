  ...
  return (
    <div className='space-y-6 p-6'>
      ...
      {(criticalAlerts.length > 0 || warningAlerts.length > 0) && (
        <LogisticsAlerts alerts={[...criticalAlerts, ...warningAlerts]} className='mb-6' />
      )}

      {/* Métricas principales */}
      <LogisticsMetricsCards stats={data.stats} derivedMetrics={derivedMetrics} />
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Últimos 10 envíos creados</CardDescription>
              </CardHeader>
              <CardContent>
                <ShipmentsList
            ...
            <Card>
              ...
              <CardContent>
                <PerformanceChart data={data.performance_metrics} height={300} />
              </CardContent>
            </Card>
          </div>
        ...
        <TabsContent value='performance' className='space-y-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Análisis detallado de performance de envíos</CardDescription>
            </CardHeader>
            <CardContent>
              <PerformanceChart data={data.performance_metrics} height={400} showDetails={true} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value='carriers'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Comparativa de rendimiento por proveedor de envío</CardDescription>
            </CardHeader>
            <CardContent>
              <CarrierPerformanceTable carriers={data.carrier_performance} />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
