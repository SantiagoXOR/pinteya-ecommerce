...
export default function SEODashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const metrics = { organicTraffic: 1250, averagePosition: 15.2, clickThroughRate: 3.8, indexedPages: 45 };
      const keywords = [];
      const alerts = [];
  ...
  const downloadSitemap = async () => {
    try {
      ...
      const sitemap = '<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"></urlset>'; // Mock
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {data.overallScore >= 80 ? 'Excelente' : 
                 data.overallScore >= 60 ? 'Bueno' : 
                 data.overallScore >= 40 ? 'Regular' : 'Necesita mejoras'}
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{data.metrics.organicTraffic.toLocaleString()}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{data.metrics.searchImpressions.toLocaleString()}</div>
                <p className="text-xs text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Métricas de rendimiento que afectan el SEO
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <Badge variant={data.metrics.coreWebVitals.lcp <= 2500 ? 'default' : 'destructive'}>
                ...
                <div className="text-center">
                  ...
                  <Badge variant={data.metrics.coreWebVitals.fid <= 100 ? 'default' : 'destructive'}>
                ...
                <div className="text-center">
                  ...
                  <Badge variant={data.metrics.coreWebVitals.cls <= 0.1 ? 'default' : 'destructive'}>
        ...
        <TabsContent value="keywords" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Top keywords y su rendimiento en búsquedas
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-muted-foreground">
                        Volumen: {keyword.searchVolume.toLocaleString()} | 
                        Dificultad: {keyword.difficulty}
                      </div>
                    </div>
                    <div className="text-center">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{data.metrics.technicalSEO.mobileUsability}%</span>
                  </div>
                  <div className="flex justify-between">
                    <span>PageSpeed:</span>
                  ...
                  <div className="flex justify-between">
                    <span>Meta tags:</span>
                    <span className="font-medium">{data.metrics.technicalSEO.metaTagsOptimization}%</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <Input 
                    id="url-analyze"
                    placeholder="https://pinteya-ecommerce.vercel.app/..."
                  />
                </div>
                <Button>
