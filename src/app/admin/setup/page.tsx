        ...
        <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-8'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-gray-600 mb-4'>
              Este proceso creará el usuario administrador principal del sistema con acceso completo
              al dashboard de analytics.
            </p>
          ...
          {result && (
            <div className='bg-green-50 border border-green-200 rounded-lg p-4 mb-6'>
              ...
              <div className='text-green-800 text-sm'>
                ...
                <p>
                  <strong>ID de Auth:</strong> {result.user?.auth_id}
                </p>
                <p>
                  <strong>Rol:</strong> {result.user?.profile?.user_roles?.role_name}
                </p>
              </div>
            </div>
          )}
          ...
          <div className='bg-gray-50 border border-gray-200 rounded-lg p-4'>
            ...
            <ol className='text-gray-700 text-sm space-y-1 list-decimal list-inside'>
              ...
              <li>
                Acceder al dashboard de analytics en <code>/admin/analytics</code>
              </li>
