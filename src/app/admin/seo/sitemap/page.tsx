          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Archivos XML generados y su estado actual
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="text-right">
                          ...
                          <Badge className={
                            ...
                            file.status === 'generating' ? 'bg-blue-100 text-blue-800' :
                            'bg-red-100 text-red-800'
                          }>
                            {file.status === 'active' ? 'Activo' :
                             file.status === 'generating' ? 'Generando' : 'Error'}
                          </Badge>
                        </div>
                        <div className="flex gap-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Análisis de contenido incluido en el sitemap
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                          <Badge className={getTypeColor(type as SitemapUrl['type'])}>
                            {type === 'homepage' ? 'Homepage' :
                             type === 'categories' ? 'Categorías' :
                             type === 'products' ? 'Productos' :
                             type === 'staticPages' ? 'Páginas Estáticas' :
                             'Blog Posts'}
                          </Badge>
          ...
          <TabsContent value="urls" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Lista completa de URLs incluidas en el sitemap
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-gray-500">
                              Última modificación: {url.lastmod.toLocaleDateString()} • 
                              Frecuencia: {url.changefreq} • 
                              Prioridad: {url.priority}
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <Badge className={getTypeColor(url.type)}>
                            {url.type}
                          </Badge>
                          <Button variant="outline" size="sm">
                            <ExternalLink className="h-4 w-4" />
          ...
          <TabsContent value="files" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Administrar archivos de sitemap XML
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                      ...
                      <div key={index} className="border rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm mb-4">
                          ...
                          <div>
                            ...
                            <div className="font-semibold">{file.lastModified.toLocaleDateString()}</div>
                          </div>
                        </div>
          ...
          <TabsContent value="settings" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Ajustes para la generación automática de sitemaps
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Comprimir archivos XML para reducir tamaño</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Crear sitemap índice para múltiples archivos</p>
                      </div>
                      <input type="checkbox" defaultChecked />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Agregar información de imágenes al sitemap</p>
                      </div>
                      <input type="checkbox" defaultChecked />
                    </div>
                  </div>
