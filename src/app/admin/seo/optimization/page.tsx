...
export default function SEOOptimizationDashboard() {
      ...
      const mockResults: OptimizationResult[] = [
        {
          ...
          issues: ['Título demasiado largo', 'Meta description faltante'],
          timestamp: new Date(),
        },
        {
          id: 'result_2',
          ...
          issues: ['Canonical tag duplicado', 'Robots.txt mal configurado'],
  ...
  const runOptimizationTool = async (toolId: string) => {
    try {
      ...
      setTools(prev =>
        prev.map(tool =>
          tool.id === toolId ? { ...tool, status: 'running' as const, lastRun: new Date() } : tool
        )
      )
    ...
    <AdminLayout
      ...
      actions={
        <div className='flex gap-2'>
          <Button variant='outline' size='sm' onClick={loadOptimizationData} disabled={running}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {Math.round(
                  tools.reduce((acc, tool) => acc + (tool.results?.score || 0), 0) / tools.length
                )}
              </div>
                    ...
                    <Card key={tool.id} className='hover:shadow-md transition-shadow'>
                      <CardHeader className='pb-3'>
                        <div className='flex items-center justify-between'>
                          <div
                            className={`p-2 rounded-lg ${getCategoryColor(tool.category)} text-white`}
                          >
          ...
          <TabsContent value='ab-testing' className='space-y-6'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Tests de optimización en tiempo real</CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-6'>
                  {abTests.map(test => (
              ...
              <CardContent className='space-y-6'>
                <div className='space-y-4'>
                  <div className='flex items-center justify-between'>
                    <div>
                      ...
                      <p className='text-sm text-gray-500'>
                        Ejecutar optimizaciones automáticamente
                      </p>
                    </div>
                    <Switch />
                  </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <Textarea placeholder='Una URL por línea...' className='mt-1' rows={4} />
                  </div>
                </div>
