  ...
  const loadAnalyticsData = async () => {
    try {
      ...
      const mockKeywords: KeywordData[] = [
        { keyword: 'pintura interior', position: 2.1, impressions: 15000, clicks: 450, ctr: 3.0, change: 5 },
        { keyword: 'pintura exterior', position: 3.5, impressions: 12000, clicks: 320, ctr: 2.7, change: -2 },
        { keyword: 'esmalte sintético', position: 1.8, impressions: 8500, clicks: 380, ctr: 4.5, change: 12 },
        { keyword: 'pintura acrílica', position: 4.2, impressions: 9200, clicks: 180, ctr: 2.0, change: -8 },
        { keyword: 'barniz madera', position: 2.9, impressions: 6800, clicks: 220, ctr: 3.2, change: 3 }
      ];

      const mockTopPages: PageMetrics[] = [
        { url: '/products/pintura-interior-premium', pageViews: 5420, organicTraffic: 3200, bounceRate: 35.2, avgPosition: 2.1 },
        { url: '/categories/pinturas-exteriores', pageViews: 4180, organicTraffic: 2800, bounceRate: 42.1, avgPosition: 3.5 },
        { url: '/products/esmalte-sintetico-blanco', pageViews: 3920, organicTraffic: 2400, bounceRate: 38.7, avgPosition: 1.8 },
        { url: '/blog/como-elegir-pintura-interior', pageViews: 3650, organicTraffic: 2100, bounceRate: 28.9, avgPosition: 4.2 },
        { url: '/products/barniz-madera-natural', pageViews: 2890, organicTraffic: 1850, bounceRate: 41.3, avgPosition: 2.9 }
      ];
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold">{formatNumber(metrics?.searchImpressions || 0)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Clicks</span>
                    <span className="font-semibold">{formatNumber(metrics?.searchClicks || 0)}</span>
                  </div>
                  <div className="flex justify-between items-center">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold">{formatCurrency(metrics?.revenueFromOrganic || 0)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Revenue por Visita</span>
                    <span className="font-semibold">
                      {formatCurrency((metrics?.revenueFromOrganic || 0) / (metrics?.organicTraffic || 1))}
                    </span>
                  </div>
                </CardContent>
              </Card>
                    ...
                    <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-500">
                          Posición {keyword.position} • {formatNumber(keyword.impressions)} impresiones
                        </div>
                      </div>
