...
export default function AdminPageSimple() {
  ...
  // Quick stats data - usando datos estáticos
  const quickStats = [
    {
      title: 'Total Productos',
      value: stats.totalProducts.toString(),
      change: `${stats.activeProducts} activos`,
    ...
    },
    {
      ...
      change: `${stats.noStockProducts} sin stock`,
  ...
  return (
    <AdminLayout title="Dashboard (Versión Simple)">
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blaze-orange-100">
                Gestiona y monitorea tu tienda de e-commerce desde aquí (Versión Simple)
              </p>
            </div>
        ...
        <AdminCard
          ...
          description="Esta es la versión simplificada sin hooks complejos"
        >
          <div className="bg-blue-50 p-4 rounded-lg">
            <p className="text-blue-800">
              ✅ Esta página usa datos estáticos en lugar del hook useAdminDashboardStats
            </p>
            <p className="text-blue-600 text-sm mt-2">
              Si esta página funciona pero /admin no, el problema está en el hook useAdminDashboardStats
            </p>
          </div>
        </AdminCard>
      </div>
