    ...
    <div className='min-h-screen bg-gray-100 py-8'>
      <div className='container mx-auto px-4'>
        <div className='mb-8 text-center'>
          ...
          <p className='text-gray-600'>Prueba y configura los emails personalizados de Pinteya</p>
        </div>
        ...
        <div className='mt-8 max-w-2xl mx-auto'>
          <div className='bg-white rounded-lg shadow-lg p-6'>
            <h2 className='text-xl font-bold text-gray-900 mb-4'>📚 Configuración de Resend</h2>
            ...
            <div className='space-y-4 text-sm text-gray-700'>
              ...
              <div>
                ...
                <p>
                  Agrega el dominio{' '}
                  <code className='bg-gray-100 px-2 py-1 rounded'>pinteya.com</code> en tu dashboard
                  de Resend
                </p>
              </div>
