...
export default function ProductsPage() {
  ...
  if (error) {
    return (
      <ErrorBoundary error={error} onRetry={refetchProducts} title='Error al cargar productos' />
    )
  }
        ...
        <TabsContent value='analytics'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Análisis detallado de performance y tendencias</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value='inventory'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Control avanzado de stock y alertas</CardDescription>
            </CardHeader>
            <CardContent>
              <div className='text-center py-12'>
