        ...
        const formattedMetrics: PerformanceMetric[] = [
          {
            ...
            unit: 'ms',
            status: (currentMetrics.metrics.LCP || 0) < 2500 ? 'good' : 
                   (currentMetrics.metrics.LCP || 0) < 4000 ? 'warning' : 'poor',
            budget: 2500,
          ...
          },
          {
            ...
            unit: 'ms',
            status: (currentMetrics.metrics.FID || 0) < 100 ? 'good' : 
                   (currentMetrics.metrics.FID || 0) < 300 ? 'warning' : 'poor',
            budget: 100,
          ...
          },
          {
            ...
            unit: 'score',
            status: (currentMetrics.metrics.CLS || 0) < 0.1 ? 'good' : 
                   (currentMetrics.metrics.CLS || 0) < 0.25 ? 'warning' : 'poor',
            budget: 0.1,
          ...
          },
          {
            ...
            unit: 'ms',
            status: (currentMetrics.metrics.FCP || 0) < 1800 ? 'good' : 
                   (currentMetrics.metrics.FCP || 0) < 3000 ? 'warning' : 'poor',
            budget: 1800,
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={getStatusColor(metric.status)}>
                    {metric.status === 'good' ? 'Bueno' : 
                     metric.status === 'warning' ? 'Regular' : 'Malo'}
                  </Badge>
                </div>
      ...
      {violations.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Métricas que exceden los límites establecidos
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <TabsContent value="server" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitoreo de recursos del servidor y base de datos
              </CardDescription>
            </CardHeader>
            <CardContent>
