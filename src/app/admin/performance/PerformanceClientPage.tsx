...
// ===================================
// ADMIN PERFORMANCE DASHBOARD CLIENT
// Componente cliente para el dashboard de performance
// ===================================
...
export function PerformanceClientPage() {
  ...
  }, [monitor]) // Solo dependemos del monitor, que es estable
    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>Monitoreo en tiempo real de métricas de performance</p>
        </div>
