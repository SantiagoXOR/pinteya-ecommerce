...
export default function OrdersPanelPage() {
  ...
  return (
    <AdminLayout
      title="Panel de Gestión de Órdenes"
      ...
      <div className="space-y-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="font-semibold text-green-800">¡AdminLayout Funcionando Perfectamente!</h3>
              <p className="text-green-700 text-sm">El problema de cache ha sido resuelto usando una ruta nueva.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">Gestiona y monitorea todas las órdenes del sistema</p>
          </div>
          <OrderListEnterprise />
        </div>
      </div>
