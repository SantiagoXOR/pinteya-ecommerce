          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Pinteya nace de la pasión por brindar soluciones completas en pinturería y ferretería. 
                Con años de experiencia en el sector, nos hemos consolidado como una empresa líder 
                en la distribución de productos de calidad.
              </p>
              <p className="text-gray-600">
                Nuestro compromiso es ofrecer productos de las mejores marcas, asesoramiento 
                especializado y un servicio excepcional que supere las expectativas de nuestros clientes.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Con presencia sólida en el mercado argentino, ofreciendo productos 
                de calidad y servicio personalizado.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">
                Seleccionamos cuidadosamente productos de las mejores marcas 
            ...
            >
              ...
              <p className="text-gray-600">
                Nuestro equipo especializado brinda asesoramiento personalizado 
                para cada proyecto y necesidad.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                ...
                honestidad y cumplimiento de compromisos.
              </p>
            </motion.div>
          </div>
        </div>
