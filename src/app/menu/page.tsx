...
const menuSections = [
  {
    ...
    items: [
      ...
      { icon: ShoppingBag, label: 'Tienda', href: '/shop', description: 'Todos los productos' },
      {
        ...
        label: 'Cotizador',
        href: '/calculator',
        description: 'Calcula tu presupuesto',
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Test Checkout',
        href: '/test-checkout',
        description: 'Pruebas de checkout',
      },
      {
        icon: Settings,
        label: 'Admin Panel',
    ...
    <>
      ...
      <section className='pb-20 pt-10'>
        <div className='max-w-[1170px] w-full mx-auto px-6 sm:px-8 xl:px-0'>
          ...
          <div className='space-y-8'>
            {menuSections.map((section, sectionIndex) => (
              <Card key={sectionIndex}>
                <CardHeader>
                  <CardTitle className='text-lg text-gray-900 dark:text-gray-200'>{section.title}</CardTitle>
                </CardHeader>
                <CardContent>
          ...
          {/* Quick Actions */}
          <div className='mt-12'>
            <h2 className='text-xl font-bold text-gray-900 mb-6 text-center'>Acciones Rápidas</h2>
          ...
          <div className='mt-12 text-center'>
            <Card>
              <CardContent className='p-6'>
                <h3 className='font-semibold text-gray-900 mb-2'>Pinteya E-commerce</h3>
