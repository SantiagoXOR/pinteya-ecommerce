  ...
  try {
    ...
    switch (action) {
      case 'create_definition':
        ...
        logger.info(
          LogLevel.INFO,
          'Custom metric definition created',
          {
    ...
    logger.error(
      LogLevel.ERROR,
      'Failed to process custom metrics request',
      {
        error: error instanceof Error ? error.message : 'Unknown error',
      },
      LogCategory.SYSTEM
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.info(
      LogLevel.INFO,
      'Custom metric definition updated',
      {
        metricId,
    ...
    logger.error(
      LogLevel.ERROR,
      'Failed to update custom metric',
      {
        error: error instanceof Error ? error.message : 'Unknown error',
      },
      LogCategory.SYSTEM
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    logger.info(
      LogLevel.INFO,
      'Custom metric definition deleted',
      {
        metricId,
        name: existing.name,
    ...
    logger.error(
      LogLevel.ERROR,
      'Failed to delete custom metric',
      {
        error: error instanceof Error ? error.message : 'Unknown error',
      },
      LogCategory.SYSTEM
