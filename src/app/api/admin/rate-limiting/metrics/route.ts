...
import { getRateLimitStats, cleanupRateLimitKeys, isRedisAvailable } from '@/lib/integrations/redis'
import { metricsCollector, memoryStore } from '@/lib/rate-limiting/enterprise-rate-limiter'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const derivedMetrics = collectorMetrics
      ? {
          successRate:
            collectorMetrics.totalRequests > 0
