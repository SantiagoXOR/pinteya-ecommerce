...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    logger.log(LogLevel.ERROR, LogCategory.API, 'Error en GET /api/admin/notifications/[id]', {
      error,
      params,
    })
    ...
    metricsCollector.recordApiCall({
      ...
      method: 'GET',
      statusCode:
        error instanceof Error && error.message === 'Notificación no encontrada' ? 404 : 500,
      responseTime: Date.now() - startTime,
...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    if (action) {
      ...
      switch (action) {
        ...
        case 'mark_unread':
          ...
          break
        case 'archive':
          updatedNotification = await archiveNotification(
    ...
    logger.log(LogLevel.ERROR, LogCategory.API, 'Error en PUT /api/admin/notifications/[id]', {
      error,
      params,
    })
...
export async function DELETE(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    logger.log(LogLevel.ERROR, LogCategory.API, 'Error en DELETE /api/admin/notifications/[id]', {
      error,
      params,
    })
