...
export async function POST(request: NextRequest) {
  try {
    ...
    if (defaultCount === 0) {
      ...
      console.log('🔄 No hay direcciones predeterminadas, marcando la más reciente:', mostRecentAddress.id);
    ...
    console.log(`✅ Validación completada. Direcciones predeterminadas finales: ${finalDefaultCount}`);
