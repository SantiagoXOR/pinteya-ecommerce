...
describe('LogisticsMap Component', () => {
  ...
  it('should render map container', () => {
    renderWithProviders(<LogisticsMap shipments={[]} />)
  ...
  it('should display shipments count correctly', () => {
    ...
    renderWithProviders(<LogisticsMap shipments={shipments} />)
  ...
  it('should render filter controls', () => {
    renderWithProviders(<LogisticsMap shipments={[mockShipment]} />)
  ...
  it('should show real-time badge when enabled', () => {
    renderWithProviders(<LogisticsMap shipments={[]} realTimeEnabled={true} />)

    expect(screen.getByText('Tiempo Real')).toBeInTheDocument()
  })

  it('should not show real-time badge when disabled', () => {
    renderWithProviders(<LogisticsMap shipments={[]} realTimeEnabled={false} />)
  ...
  it('should call onShipmentSelect when shipment is selected', () => {
    ...
    renderWithProviders(
      <LogisticsMap shipments={[mockShipment]} onShipmentSelect={onShipmentSelect} />
    )
  ...
  it('should be responsive', () => {
    const { container } = renderWithProviders(<LogisticsMap shipments={[]} />)
  ...
  it('should handle invalid shipment data', () => {
    ...
    expect(() => {
      renderWithProviders(<LogisticsMap shipments={invalidShipments} />)
    }).not.toThrow()
  })
  ...
  it('should handle large number of shipments', () => {
    ...
    renderWithProviders(<LogisticsMap shipments={manyShipments} />)
  ...
  it('should cleanup resources on unmount', () => {
    const { unmount } = renderWithProviders(<LogisticsMap shipments={[]} />)
