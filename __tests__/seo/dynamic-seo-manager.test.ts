...
describe('DynamicSEOManager', () => {
  ...
  describe('Product Metadata Generation', () => {
    ...
    test('genera metadata completa para productos', () => {
      ...
      expect(metadata.title).toBe(
        'Pintura Sherwin Williams Interior - Sherwin Williams | Pinteya E-commerce'
      )
      expect(metadata.description).toContain(
        'Compra Pintura Sherwin Williams Interior de Sherwin Williams en Pinteya'
      )
  ...
  describe('Category Metadata Generation', () => {
    ...
    test('incluye canonical URL para categorías', () => {
      ...
      expect(metadata.alternates?.canonical).toBe(
        `${SITE_CONFIG.url}/categories/${mockCategory.slug}`
      )
    })
  ...
  describe('Page Metadata Generation', () => {
    ...
    test('genera metadata para páginas generales', () => {
      ...
      expect(metadata.description).toBe(
        'Completa tu compra de forma segura y rápida en Pinteya E-commerce.'
      )
      expect(metadata.keywords).toContain('pinturería online')
    })
  ...
  describe('SEO Utilities', () => {
    test('optimiza títulos correctamente', () => {
      const longTitle =
        'Este es un título muy largo que excede los 60 caracteres recomendados para SEO'
    ...
    test('optimiza descripciones correctamente', () => {
      const longDescription =
        'Esta es una descripción muy larga que excede los 160 caracteres recomendados para meta descriptions en SEO y necesita ser truncada apropiadamente.'
    ...
    test('extrae keywords relevantes del texto', () => {
      const text =
        'Pintura de alta calidad para interiores y exteriores. Excelente cobertura y durabilidad. Ideal para proyectos profesionales.'
  ...
  describe('SEO Validation', () => {
    ...
    test('detecta descripción muy larga', () => {
      const invalidConfig = {
        title: 'Título válido',
        description:
          'Esta es una descripción extremadamente larga que excede los 160 caracteres recomendados para meta descriptions y debería ser detectada como inválida por el validador',
        keywords: ['keyword1'],
      }
