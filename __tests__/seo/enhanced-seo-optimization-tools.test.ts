...
describe('Enhanced SEO Optimization Tools', () => {
  ...
  describe('Competitor Analysis', () => {
    ...
    test('should handle competitor analysis errors', async () => {
      ...
      await expect(seoTools.analyzeCompetitors(['test.com'])).rejects.toThrow(
        'Competitor analysis is disabled'
      )
    })
  ...
  describe('A/B Testing', () => {
    ...
    test('should update A/B test metrics', async () => {
      ...
      await expect(
        seoTools.updateABTestMetrics(testId, 'variant_0', {
          impressions: 100,
          clicks: 5,
          conversions: 1,
        })
  ...
  describe('Core Web Vitals', () => {
    ...
    test('should handle Core Web Vitals errors', async () => {
      ...
      await expect(seoTools.analyzeCoreWebVitals('https://test.com')).rejects.toThrow(
        'Core Web Vitals optimization is disabled'
      )
    })
  })
  ...
  describe('Content Optimization', () => {
    ...
    test('should handle content optimization errors', async () => {
      ...
      await expect(seoTools.optimizeContent('https://test.com', 'product')).rejects.toThrow(
        'Content optimization is disabled'
      )
    })
  })
  ...
  describe('Technical SEO Audit', () => {
    ...
    test('should handle technical audit errors', async () => {
      ...
      await expect(seoTools.performTechnicalAudit('https://test.com')).rejects.toThrow(
        'Technical SEO audit is disabled'
      )
    })
  })
  ...
  describe('Automated Recommendations', () => {
    test('should generate automated recommendations', async () => {
      ...
      expect(['keyword', 'content', 'technical', 'competitor', 'performance']).toContain(
        recommendation.type
      )
  ...
  describe('Error Handling', () => {
    ...
    test('should handle missing A/B test', async () => {
      await expect(seoTools.updateABTestMetrics('nonexistent', 'variant_0', {})).rejects.toThrow(
        'A/B Test nonexistent not found'
      )
    })
    ...
    test('should handle invalid variant ID', async () => {
      ...
      await expect(seoTools.updateABTestMetrics(testId, 'invalid_variant', {})).rejects.toThrow(
        'Variant invalid_variant not found'
      )
    })
  })
})
