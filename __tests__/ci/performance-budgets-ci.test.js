...
describe('Performance Budgets CI/CD System', () => {
  ...
  describe('Budget Configuration', () => {
    ...
    it('should have helper functions working correctly', () => {
      ...
      const prodBudget = helpers.getBudgetForEnvironment(
        'totalBundleSize',
        'critical',
        'production'
      )
      const devBudget = helpers.getBudgetForEnvironment(
        'totalBundleSize',
        'critical',
        'development'
      )
  ...
  describe('CIPerformanceChecker', () => {
    ...
    it('should determine build failure correctly', () => {
      ...
      checker.results.violations = [{ failBuild: false, severity: 'warning' }]
  ...
  describe('Environment Configuration', () => {
    it('should apply correct multipliers for different environments', () => {
      ...
      const prodBudget = budgetConfig.helpers.getBudgetForEnvironment(
        'test',
        'critical',
        'production'
      )
      ...
      const realProdBudget = budgetConfig.helpers.getBudgetForEnvironment(
        'totalBundleSize',
        'critical',
        'production'
      )
      const realDevBudget = budgetConfig.helpers.getBudgetForEnvironment(
        'totalBundleSize',
        'critical',
        'development'
      )
