  ...
  describe('GET /api/seo/testing', () => {
    ...
    test('should return test history', async () => {
      const request = new NextRequest(
        'http://localhost:3000/api/seo/testing?action=history&limit=5'
      )
      const response = await GET(request)
      const data = await response.json()
    ...
    test('should run tests by type', async () => {
      const request = new NextRequest(
        'http://localhost:3000/api/seo/testing?action=run-by-type&testType=metadata&urls=/test-page'
      )
      const response = await GET(request)
      const data = await response.json()
    ...
    test('should return error for invalid test type', async () => {
      const request = new NextRequest(
        'http://localhost:3000/api/seo/testing?action=run-by-type&testType=invalid'
      )
      const response = await GET(request)
      const data = await response.json()
