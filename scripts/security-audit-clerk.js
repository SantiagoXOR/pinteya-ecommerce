...
async function auditClerkSecurity() {
  ...
  try {
    ...
    console.log('CLERK_SECRET_KEY:', process.env.CLERK_SECRET_KEY ? '✅ Configurada' : '❌ Faltante');
    console.log('NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY:', process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY ? '✅ Configurada' : '❌ Faltante');
