...
function generateCoverageReport() {
  ...
  const command = 'npx jest --config=jest.config.animations.js --coverage --coverageReporters=html --coverageReporters=text --coverageReporters=lcov';
...
function runPerformanceTests() {
  ...
  const command = 'npx jest --config=jest.config.animations.js --testNamePattern="Performance|performance" --verbose';
...
function runAccessibilityTests() {
  ...
  const command = 'npx jest --config=jest.config.animations.js --testNamePattern="Accesibilidad|accessibility|a11y" --verbose';
