...
const CRITICAL_PATTERNS = [
  ...
  {
    pattern: /[STRIPE_PUBLIC_KEY_REMOVED][a-zA-Z0-9]+/g,
    type: 'Clerk Test Publishable Key',
    severity: 'MEDIUM',
  },
  {
    pattern: /[STRIPE_SECRET_KEY_REMOVED][a-zA-Z0-9]+/g,
    type: 'Clerk Test Secret Key',
    severity: 'MEDIUM',
  },

  // MercadoPago
  {
    pattern: /APP_USR-[0-9]+-[0-9]+-[a-zA-Z0-9]+-[0-9]+/g,
    type: 'MercadoPago Access Token',
    severity: 'CRITICAL',
  },
