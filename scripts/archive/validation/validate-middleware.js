...
function validateClerkDependencies() {
  ...
  const requiredDeps = ['@clerk/nextjs', 'next']
...
function validateEnvironmentVariables() {
  ...
  const optionalEnvVars = ['CLERK_WEBHOOK_SECRET']
...
async function main() {
  try {
    ...
    console.log(
      `✅ ${middlewareValidation.passed}/${middlewareValidation.total} verificaciones pasadas`
    )
