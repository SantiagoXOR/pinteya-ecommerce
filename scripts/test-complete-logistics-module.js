...
async function main() {
  ...
  try {
    ...
    logSuccess(`APIs del módulo: ${moduleResults.workingAPIs}/${moduleResults.totalAPIs} funcionando`);
    logSuccess(`Métodos HTTP: ${methodResults.passedTests}/${methodResults.methodTests} implementados`);
    logSuccess(`Parámetros/Filtros: ${paramResults.passedParams}/${paramResults.paramTests} funcionando`);
    
    const totalTests = moduleResults.totalAPIs + methodResults.methodTests + paramResults.paramTests;
    const totalPassed = moduleResults.workingAPIs + methodResults.passedTests + paramResults.passedParams;
