...
def main():
    ...
    replacements = [
        "GOCSPX-[GOOGLE_OAUTH_SECRET_PATTERN]==>[GOOGLE_OAUTH_SECRET_REMOVED]",
        "[GOOGLE_OAUTH_CLIENT_ID_PATTERN]==>[GOOGLE_OAUTH_CLIENT_ID_REMOVED]",
        "sb_publishable_[PATTERN]==>[SUPABASE_ANON_KEY_REMOVED]",
        "sb_secret_[PATTERN]==>[SUPABASE_SERVICE_ROLE_KEY_REMOVED]",
        "[SUPABASE_ANON_KEY_PATTERN]==>[SUPABASE_ANON_KEY_REMOVED]",
        "[SUPABASE_SERVICE_ROLE_KEY_PATTERN]==>[SUPABASE_SERVICE_ROLE_KEY_REMOVED]",
        ...
        "whsec_[WEBHOOK_SECRET_PATTERN]==>[WEBHOOK_SECRET_REMOVED]",
