...
async function main() {
  ...
  try {
    ...
    const cleanupResult = await runCommand('npx playwright test --project=cleanup', 'Cleanup')
    ...
    const overallSuccess =
      setupResult.success && (adminTestsResult.success || publicTestsResult.success)
