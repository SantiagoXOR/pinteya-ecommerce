...
const testConfig = {
  unit: {
    name: 'Unit Tests',
    command:
      'npx jest --config=jest.config.enterprise.js --testPathPattern="__tests__.*\\.test\\.(js|ts|tsx)$" --coverage',
    timeout: 300000, // 5 minutes
  },
  integration: {
    name: 'Integration Tests',
    command:
      'npx jest --config=jest.config.enterprise.js --testPathPattern="integration.*\\.test\\.(js|ts)$" --coverage',
