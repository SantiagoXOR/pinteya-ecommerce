...
const generateRecommendations = (results) => {
  ...
  if (!results.unit?.success) {
    recommendations.push('🔧 Revisar tests unitarios - pueden indicar problemas en la lógica de componentes');
  }

  if (!results.integration?.success) {
    recommendations.push('🔗 Verificar integración entre componentes - posibles problemas de comunicación');
  }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="coverage">
                ...
                ${Object.entries(report.coverage).filter(([_, cov]) => cov).map(([type, cov]) => `
