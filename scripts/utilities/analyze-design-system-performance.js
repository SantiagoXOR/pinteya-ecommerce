...
function analyzeTreeShaking() {
  ...
  return {
    ...
    recommendation: exports.length > 0 ? 'Tree-shaking configurado correctamente' : 'Agregar exports al index.ts'
  };
}
...
function generateReport() {
  ...
  const report = {
    ...
    summary: {
      ...
      totalRecommendations: bundleAnalysis.recommendations.length + dependencies.recommendations.length + performance.length,
