...
function generateNextSteps() {
  ...
  if (activationStatus.migrationOpportunities.length > 0) {
    const highPriority = activationStatus.migrationOpportunities.filter(
...
### Alta Prioridad
${activationStatus.migrationOpportunities
...
**Recomendación**: ${
    activationStatus.productionReady
