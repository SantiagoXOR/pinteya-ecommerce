-- ============================================================================
-- MIGRACIÓN: Mapear event_name 'view_category' a event_type 15 en RPC
-- ============================================================================
-- El tipo 15 (view_category) ya existe en analytics_event_types; el RPC
-- no lo mapeaba y guardaba view_category como page_view (ELSE 1).
-- ============================================================================
...
COMMENT ON FUNCTION insert_analytics_event_optimized IS 'Inserta eventos de analytics con metadata y tenant_id. Incluye mapeo view_category (15) y search_query (action 5).';
