-- ============================================================================
-- MIGRACIÓN: Añadir p_tenant_id a insert_analytics_event_optimized
-- ============================================================================
-- Descripción: La API /api/analytics/events y /api/track/events envían
-- p_tenant_id para aislamiento multitenant. Esta migración actualiza la RPC
-- para aceptar el parámetro y persistir tenant_id en analytics_events_optimized.
-- ============================================================================
...
CREATE OR REPLACE FUNCTION insert_analytics_event_optimized(
    ...
    -- MULTITENANT: tenant que genera el evento (Pinteya, Pintemas, etc.)
...
COMMENT ON FUNCTION insert_analytics_event_optimized IS 'Inserta eventos de analytics con metadata y tenant_id para aislamiento multitenant (Pinteya, Pintemas, etc.)';
