...
|---------|-------|-------|--------|
| LCP | 17.3 s | 0/100 | 🔴 poor |
| FCP | 3.2 s | 43/100 | 🔴 poor |
| CLS | 0 | 100/100 | 🟢 good |
| TBT | 1,210 ms | 20/100 | 🔴 poor |
| SI | 7.9 s | 23/100 | 🔴 poor |
| TTI | 17.6 s | 4/100 | 🔴 undefined |

### 🎯 Oportunidades de Mejora (Top 10)

1. **Reduce unused JavaScript** - Ahorro potencial: 890ms
...
2. **Defer offscreen images** - Ahorro potencial: 220ms
...
4. **Avoid serving legacy JavaScript to modern browsers** - Ahorro potencial: 170ms
...
5. **Initial server response time was short** - Ahorro potencial: 43ms
...
| Métrica | Valor | Score | Estado |
|---------|-------|-------|--------|
| LCP | 3.2 s | 72/100 | 🟡 needs-improvement |
| FCP | 0.7 s | 100/100 | 🟢 good |
| CLS | 0 | 100/100 | 🟢 good |
| TBT | 60 ms | 100/100 | 🟢 good |
| SI | 2.0 s | 99/100 | 🟢 good |
| TTI | 3.3 s | 94/100 | 🔴 undefined |

### 🎯 Oportunidades de Mejora (Top 10)

1. **Reduce unused JavaScript** - Ahorro potencial: 50ms
   Reduce unused JavaScript and defer loading scripts until they are required to decrease bytes consumed by network activity. [Learn how to reduce unused...

2. **Initial server response time was short** - Ahorro potencial: 41ms
   Keep the server response time for the main document short because all other requests depend on it. [Learn more about the Time to First Byte metric](ht...
...
- **Optimización de Imágenes**: 1 oportunidades identificadas
